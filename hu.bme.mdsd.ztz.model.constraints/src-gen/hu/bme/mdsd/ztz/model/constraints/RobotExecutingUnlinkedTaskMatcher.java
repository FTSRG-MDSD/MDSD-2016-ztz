 ...
 * )
 * pattern robotExecutingUnlinkedTask(robot: Robot, task: Task) {
...
public class RobotExecutingUnlinkedTaskMatcher extends BaseMatcher<RobotExecutingUnlinkedTaskMatch> {
   ...
   * 
   */
  public Collection<RobotExecutingUnlinkedTaskMatch> getAllMatches(final Robot pRobot, final Task pTask) {
   ...
   * 
   */
  public RobotExecutingUnlinkedTaskMatch getOneArbitraryMatch(final Robot pRobot, final Task pTask) {
   ...
   * 
   */
  public void forEachMatch(final Robot pRobot, final Task pTask, final IMatchProcessor<? super RobotExecutingUnlinkedTaskMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Robot pRobot, final Task pTask, final IMatchProcessor<? super RobotExecutingUnlinkedTaskMatch> processor) {
   ...
   * 
   */
  public RobotExecutingUnlinkedTaskMatch newMatch(final Robot pRobot, final Task pTask) {
   ...
   * 
   */
  public Set<Robot> getAllValuesOfrobot(final RobotExecutingUnlinkedTaskMatch partialMatch) {
  ...
  protected RobotExecutingUnlinkedTaskMatch tupleToMatch(final Tuple t) {
    try {
    	return RobotExecutingUnlinkedTaskMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Robot) t.get(POSITION_ROBOT), (hu.bme.mdsd.ztz.model.drone.Task) t.get(POSITION_TASK));
  ...
  protected RobotExecutingUnlinkedTaskMatch arrayToMatch(final Object[] match) {
    try {
    	return RobotExecutingUnlinkedTaskMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Robot) match[POSITION_ROBOT], (hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK]);
    } catch(ClassCastException e) {
  ...
  protected RobotExecutingUnlinkedTaskMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RobotExecutingUnlinkedTaskMatch.newMutableMatch((hu.bme.mdsd.ztz.model.drone.Robot) match[POSITION_ROBOT], (hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
