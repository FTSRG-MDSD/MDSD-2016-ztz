...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.taskRequirementHasCapability pattern,
 * to be used in conjunction with {@link TaskRequirementHasCapabilityMatcher}.
 * 
...
public abstract class TaskRequirementHasCapabilityMatch extends BasePatternMatch {
  ...
  private TaskRequirementHasCapabilityMatch(final TaskRequirement pRequirement, final Capability pCapability) {
  ...
  public List<String> parameterNames() {
    return TaskRequirementHasCapabilityMatch.parameterNames;
  }
  ...
  @Override
  public TaskRequirementHasCapabilityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TaskRequirementHasCapabilityMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TaskRequirementHasCapabilityMatch other = (TaskRequirementHasCapabilityMatch) obj;
  ...
  @Override
  public TaskRequirementHasCapabilityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TaskRequirementHasCapabilityMatch newEmptyMatch() {
   ...
   * 
   */
  public static TaskRequirementHasCapabilityMatch newMutableMatch(final TaskRequirement pRequirement, final Capability pCapability) {
   ...
   * 
   */
  public static TaskRequirementHasCapabilityMatch newMatch(final TaskRequirement pRequirement, final Capability pCapability) {
    return new Immutable(pRequirement, pCapability);
  }
  
  private static final class Mutable extends TaskRequirementHasCapabilityMatch {
  ...
  private static final class Immutable extends TaskRequirementHasCapabilityMatch {
