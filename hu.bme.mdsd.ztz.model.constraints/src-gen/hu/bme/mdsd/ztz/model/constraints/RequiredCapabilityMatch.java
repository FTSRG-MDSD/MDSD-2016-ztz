...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.requiredCapability pattern,
 * to be used in conjunction with {@link RequiredCapabilityMatcher}.
 * 
...
public abstract class RequiredCapabilityMatch extends BasePatternMatch {
  ...
  private RequiredCapabilityMatch(final TaskRequirement pRequirement, final Capability pCapability) {
  ...
  public List<String> parameterNames() {
    return RequiredCapabilityMatch.parameterNames;
  }
  ...
  @Override
  public RequiredCapabilityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RequiredCapabilityMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RequiredCapabilityMatch other = (RequiredCapabilityMatch) obj;
  ...
  @Override
  public RequiredCapabilityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RequiredCapabilityMatch newEmptyMatch() {
   ...
   * 
   */
  public static RequiredCapabilityMatch newMutableMatch(final TaskRequirement pRequirement, final Capability pCapability) {
   ...
   * 
   */
  public static RequiredCapabilityMatch newMatch(final TaskRequirement pRequirement, final Capability pCapability) {
    return new Immutable(pRequirement, pCapability);
  }
  
  private static final class Mutable extends RequiredCapabilityMatch {
  ...
  private static final class Immutable extends RequiredCapabilityMatch {
