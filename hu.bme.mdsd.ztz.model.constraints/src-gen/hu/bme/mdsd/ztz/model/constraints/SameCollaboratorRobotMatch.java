...
public abstract class SameCollaboratorRobotMatch extends BasePatternMatch {
  ...
  private SameCollaboratorRobotMatch(final DynamicRobot pRobot) {
    this.fRobot = pRobot;
  }
   ...
   * 
   */
  public static SameCollaboratorRobotMatch newMutableMatch(final DynamicRobot pRobot) {
   ...
   * 
   */
  public static SameCollaboratorRobotMatch newMatch(final DynamicRobot pRobot) {
    return new Immutable(pRobot);
  }
  
  private static final class Mutable extends SameCollaboratorRobotMatch {
    Mutable(final DynamicRobot pRobot) {
      super(pRobot);
    }
  ...
  private static final class Immutable extends SameCollaboratorRobotMatch {
    Immutable(final DynamicRobot pRobot) {
      super(pRobot);
    }
