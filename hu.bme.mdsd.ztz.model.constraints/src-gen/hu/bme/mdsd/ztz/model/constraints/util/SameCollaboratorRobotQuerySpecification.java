...
public final class SameCollaboratorRobotQuerySpecification extends BaseGeneratedEMFQuerySpecification<SameCollaboratorRobotMatcher> {
  ...
  public SameCollaboratorRobotMatch newMatch(final Object... parameters) {
    return SameCollaboratorRobotMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Robot) parameters[0]);
  }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_robot, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/drone", "Robot", "collaborations")));
      		PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
      		new TypeConstraint(body, new FlatTuple(var__virtual_0_, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/drone", "RobotCollaboration", "collaborator")));
