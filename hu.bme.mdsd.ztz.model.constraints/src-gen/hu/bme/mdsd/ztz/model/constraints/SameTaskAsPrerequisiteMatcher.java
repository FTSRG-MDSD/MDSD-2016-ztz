...
public class SameTaskAsPrerequisiteMatcher extends BaseMatcher<SameTaskAsPrerequisiteMatch> {
   ...
   * 
   */
  public Collection<SameTaskAsPrerequisiteMatch> getAllMatches(final Task pTask) {
   ...
   * 
   */
  public SameTaskAsPrerequisiteMatch getOneArbitraryMatch(final Task pTask) {
   ...
   * 
   */
  public void forEachMatch(final Task pTask, final IMatchProcessor<? super SameTaskAsPrerequisiteMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Task pTask, final IMatchProcessor<? super SameTaskAsPrerequisiteMatch> processor) {
   ...
   * 
   */
  public SameTaskAsPrerequisiteMatch newMatch(final Task pTask) {
    return SameTaskAsPrerequisiteMatch.newMatch(pTask);
  }
  ...
  protected SameTaskAsPrerequisiteMatch tupleToMatch(final Tuple t) {
    try {
    	return SameTaskAsPrerequisiteMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Task) t.get(POSITION_TASK));
  ...
  protected SameTaskAsPrerequisiteMatch arrayToMatch(final Object[] match) {
    try {
    	return SameTaskAsPrerequisiteMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK]);
    } catch(ClassCastException e) {
  ...
  protected SameTaskAsPrerequisiteMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SameTaskAsPrerequisiteMatch.newMutableMatch((hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
