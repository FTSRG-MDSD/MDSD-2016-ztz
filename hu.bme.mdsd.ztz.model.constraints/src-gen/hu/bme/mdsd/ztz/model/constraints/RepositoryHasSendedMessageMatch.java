...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.repositoryHasSendedMessage pattern,
 * to be used in conjunction with {@link RepositoryHasSendedMessageMatcher}.
 * 
...
public abstract class RepositoryHasSendedMessageMatch extends BasePatternMatch {
  ...
  private RepositoryHasSendedMessageMatch(final MessageRepository pRepository, final Message pMessage) {
  ...
  public List<String> parameterNames() {
    return RepositoryHasSendedMessageMatch.parameterNames;
  }
  ...
  @Override
  public RepositoryHasSendedMessageMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RepositoryHasSendedMessageMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RepositoryHasSendedMessageMatch other = (RepositoryHasSendedMessageMatch) obj;
  ...
  @Override
  public RepositoryHasSendedMessageQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RepositoryHasSendedMessageMatch newEmptyMatch() {
   ...
   * 
   */
  public static RepositoryHasSendedMessageMatch newMutableMatch(final MessageRepository pRepository, final Message pMessage) {
   ...
   * 
   */
  public static RepositoryHasSendedMessageMatch newMatch(final MessageRepository pRepository, final Message pMessage) {
    return new Immutable(pRepository, pMessage);
  }
  
  private static final class Mutable extends RepositoryHasSendedMessageMatch {
  ...
  private static final class Immutable extends RepositoryHasSendedMessageMatch {
