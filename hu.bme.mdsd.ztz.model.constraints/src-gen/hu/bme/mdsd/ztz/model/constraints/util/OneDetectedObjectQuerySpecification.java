...
public final class OneDetectedObjectQuerySpecification extends BaseGeneratedEMFQuerySpecification<OneDetectedObjectMatcher> {
  ...
  public OneDetectedObjectMatch newMatch(final Object... parameters) {
    return OneDetectedObjectMatch.newMatch((hu.bme.mdsd.ztz.model.drone.AreaObject) parameters[0], (hu.bme.mdsd.ztz.model.behaviour.DetectedObject) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("object", "hu.bme.mdsd.ztz.model.drone.AreaObject"),new PParameter("detected1", "hu.bme.mdsd.ztz.model.behaviour.DetectedObject"));
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_detected1), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.mdsd.hu/behaviour", "DetectedObject")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_robot, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/behaviour", "DynamicRobot", "detectedObjects")));
      		new Equality(body, var__virtual_0_, var_detected1);
      		// 	DynamicRobot.detectedObjects(robot, detected2)
      		new TypeConstraint(body, new FlatTuple(var_robot), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.mdsd.hu/behaviour", "DynamicRobot")));
      		PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
      		new TypeConstraint(body, new FlatTuple(var_robot, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/behaviour", "DynamicRobot", "detectedObjects")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_detected1, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/behaviour", "DetectedObject", "object")));
      		new Equality(body, var__virtual_2_, var_object);
      		// 	DetectedObject.object(detected2, object)
      		new TypeConstraint(body, new FlatTuple(var_detected2), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.mdsd.hu/behaviour", "DetectedObject")));
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new TypeConstraint(body, new FlatTuple(var_detected2, var__virtual_3_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/behaviour", "DetectedObject", "object")));
