...
public abstract class SameTaskAsPrerequisiteMatch extends BasePatternMatch {
  ...
  private SameTaskAsPrerequisiteMatch(final Task pTask) {
    this.fTask = pTask;
  }
   ...
   * 
   */
  public static SameTaskAsPrerequisiteMatch newMutableMatch(final Task pTask) {
   ...
   * 
   */
  public static SameTaskAsPrerequisiteMatch newMatch(final Task pTask) {
