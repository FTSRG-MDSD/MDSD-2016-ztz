...
public final class RobotExecutingUnlinkedTaskQuerySpecification extends BaseGeneratedEMFQuerySpecification<RobotExecutingUnlinkedTaskMatcher> {
  ...
  public RobotExecutingUnlinkedTaskMatch newMatch(final Object... parameters) {
    return RobotExecutingUnlinkedTaskMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.DynamicRobot) parameters[0], (hu.bme.mdsd.ztz.model.drone.Task) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("robot", "hu.bme.mdsd.ztz.model.behaviour.DynamicRobot"),new PParameter("task", "hu.bme.mdsd.ztz.model.drone.Task"));
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_robot, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/behaviour", "DynamicRobot", "executedTasks")));
