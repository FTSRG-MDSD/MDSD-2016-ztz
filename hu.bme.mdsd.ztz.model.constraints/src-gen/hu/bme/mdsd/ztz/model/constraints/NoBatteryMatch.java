...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.noBattery pattern,
 * to be used in conjunction with {@link NoBatteryMatcher}.
 * 
...
public abstract class NoBatteryMatch extends BasePatternMatch {
  private Robot fRobot;
  
  private static List<String> parameterNames = makeImmutableList("robot");
  
  private NoBatteryMatch(final Robot pRobot) {
    this.fRobot = pRobot;
  }
  ...
  public List<String> parameterNames() {
    return NoBatteryMatch.parameterNames;
  }
  ...
  @Override
  public NoBatteryMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NoBatteryMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NoBatteryMatch other = (NoBatteryMatch) obj;
  ...
  @Override
  public NoBatteryQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NoBatteryMatch newEmptyMatch() {
   ...
   * 
   */
  public static NoBatteryMatch newMutableMatch(final Robot pRobot) {
   ...
   * 
   */
  public static NoBatteryMatch newMatch(final Robot pRobot) {
    return new Immutable(pRobot);
  }
  
  private static final class Mutable extends NoBatteryMatch {
  ...
  private static final class Immutable extends NoBatteryMatch {
