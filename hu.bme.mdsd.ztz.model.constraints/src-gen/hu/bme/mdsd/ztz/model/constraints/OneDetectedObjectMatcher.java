...
public class OneDetectedObjectMatcher extends BaseMatcher<OneDetectedObjectMatch> {
  ...
  protected OneDetectedObjectMatch tupleToMatch(final Tuple t) {
    try {
    	return OneDetectedObjectMatch.newMatch((hu.bme.mdsd.ztz.model.drone.AreaObject) t.get(POSITION_OBJECT), (hu.bme.mdsd.ztz.model.behaviour.DetectedObject) t.get(POSITION_DETECTED1));
  ...
  protected OneDetectedObjectMatch arrayToMatch(final Object[] match) {
    try {
    	return OneDetectedObjectMatch.newMatch((hu.bme.mdsd.ztz.model.drone.AreaObject) match[POSITION_OBJECT], (hu.bme.mdsd.ztz.model.behaviour.DetectedObject) match[POSITION_DETECTED1]);
    } catch(ClassCastException e) {
  ...
  protected OneDetectedObjectMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OneDetectedObjectMatch.newMutableMatch((hu.bme.mdsd.ztz.model.drone.AreaObject) match[POSITION_OBJECT], (hu.bme.mdsd.ztz.model.behaviour.DetectedObject) match[POSITION_DETECTED1]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
