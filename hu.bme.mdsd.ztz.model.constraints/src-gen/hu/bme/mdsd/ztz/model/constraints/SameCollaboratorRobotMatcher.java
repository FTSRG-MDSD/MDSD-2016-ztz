...
public class SameCollaboratorRobotMatcher extends BaseMatcher<SameCollaboratorRobotMatch> {
   ...
   * 
   */
  public Collection<SameCollaboratorRobotMatch> getAllMatches(final DynamicRobot pRobot) {
   ...
   * 
   */
  public SameCollaboratorRobotMatch getOneArbitraryMatch(final DynamicRobot pRobot) {
   ...
   * 
   */
  public boolean hasMatch(final DynamicRobot pRobot) {
   ...
   * 
   */
  public int countMatches(final DynamicRobot pRobot) {
   ...
   * 
   */
  public void forEachMatch(final DynamicRobot pRobot, final IMatchProcessor<? super SameCollaboratorRobotMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final DynamicRobot pRobot, final IMatchProcessor<? super SameCollaboratorRobotMatch> processor) {
   ...
   * 
   */
  public SameCollaboratorRobotMatch newMatch(final DynamicRobot pRobot) {
  ...
  protected SameCollaboratorRobotMatch tupleToMatch(final Tuple t) {
    try {
    	return SameCollaboratorRobotMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.DynamicRobot) t.get(POSITION_ROBOT));
  ...
  protected SameCollaboratorRobotMatch arrayToMatch(final Object[] match) {
    try {
    	return SameCollaboratorRobotMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.DynamicRobot) match[POSITION_ROBOT]);
    } catch(ClassCastException e) {
  ...
  protected SameCollaboratorRobotMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SameCollaboratorRobotMatch.newMutableMatch((hu.bme.mdsd.ztz.model.behaviour.DynamicRobot) match[POSITION_ROBOT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
