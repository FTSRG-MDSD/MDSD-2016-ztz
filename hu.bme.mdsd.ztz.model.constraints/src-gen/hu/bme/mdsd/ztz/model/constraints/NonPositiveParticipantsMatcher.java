...
public class NonPositiveParticipantsMatcher extends BaseMatcher<NonPositiveParticipantsMatch> {
  ...
  protected NonPositiveParticipantsMatch tupleToMatch(final Tuple t) {
    try {
    	return NonPositiveParticipantsMatch.newMatch((hu.bme.mdsd.ztz.model.drone.TaskRequirement) t.get(POSITION_REQUIREMENT));
  ...
  protected NonPositiveParticipantsMatch arrayToMatch(final Object[] match) {
    try {
    	return NonPositiveParticipantsMatch.newMatch((hu.bme.mdsd.ztz.model.drone.TaskRequirement) match[POSITION_REQUIREMENT]);
    } catch(ClassCastException e) {
  ...
  protected NonPositiveParticipantsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return NonPositiveParticipantsMatch.newMutableMatch((hu.bme.mdsd.ztz.model.drone.TaskRequirement) match[POSITION_REQUIREMENT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
