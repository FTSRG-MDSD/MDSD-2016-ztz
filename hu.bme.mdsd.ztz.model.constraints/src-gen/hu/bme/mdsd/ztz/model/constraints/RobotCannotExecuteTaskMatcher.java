 ...
 * )
 * pattern robotCannotExecuteTask(robot: Robot, task: Task, capability: Capability) {
...
public class RobotCannotExecuteTaskMatcher extends BaseMatcher<RobotCannotExecuteTaskMatch> {
   ...
   * 
   */
  public Collection<RobotCannotExecuteTaskMatch> getAllMatches(final Robot pRobot, final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public RobotCannotExecuteTaskMatch getOneArbitraryMatch(final Robot pRobot, final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public boolean hasMatch(final Robot pRobot, final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public int countMatches(final Robot pRobot, final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public void forEachMatch(final Robot pRobot, final Task pTask, final Capability pCapability, final IMatchProcessor<? super RobotCannotExecuteTaskMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Robot pRobot, final Task pTask, final Capability pCapability, final IMatchProcessor<? super RobotCannotExecuteTaskMatch> processor) {
   ...
   * 
   */
  public RobotCannotExecuteTaskMatch newMatch(final Robot pRobot, final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public Set<Robot> getAllValuesOfrobot(final RobotCannotExecuteTaskMatch partialMatch) {
   ...
   * 
   */
  public Set<Robot> getAllValuesOfrobot(final Task pTask, final Capability pCapability) {
   ...
   * 
   */
  public Set<Task> getAllValuesOftask(final RobotCannotExecuteTaskMatch partialMatch) {
   ...
   * 
   */
  public Set<Task> getAllValuesOftask(final Robot pRobot, final Capability pCapability) {
   ...
   * 
   */
  public Set<Capability> getAllValuesOfcapability(final Robot pRobot, final Task pTask) {
  ...
  protected RobotCannotExecuteTaskMatch tupleToMatch(final Tuple t) {
    try {
    	return RobotCannotExecuteTaskMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Robot) t.get(POSITION_ROBOT), (hu.bme.mdsd.ztz.model.drone.Task) t.get(POSITION_TASK), (hu.bme.mdsd.ztz.model.drone.Capability) t.get(POSITION_CAPABILITY));
  ...
  protected RobotCannotExecuteTaskMatch arrayToMatch(final Object[] match) {
    try {
    	return RobotCannotExecuteTaskMatch.newMatch((hu.bme.mdsd.ztz.model.drone.Robot) match[POSITION_ROBOT], (hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK], (hu.bme.mdsd.ztz.model.drone.Capability) match[POSITION_CAPABILITY]);
    } catch(ClassCastException e) {
  ...
  protected RobotCannotExecuteTaskMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RobotCannotExecuteTaskMatch.newMutableMatch((hu.bme.mdsd.ztz.model.drone.Robot) match[POSITION_ROBOT], (hu.bme.mdsd.ztz.model.drone.Task) match[POSITION_TASK], (hu.bme.mdsd.ztz.model.drone.Capability) match[POSITION_CAPABILITY]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
