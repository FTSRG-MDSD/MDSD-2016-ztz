...
public abstract class RobotExecutingUnlinkedTaskMatch extends BasePatternMatch {
  ...
  private RobotExecutingUnlinkedTaskMatch(final Robot pRobot, final Task pTask) {
    this.fRobot = pRobot;
    this.fTask = pTask;
  }
   ...
   * 
   */
  public static RobotExecutingUnlinkedTaskMatch newMutableMatch(final Robot pRobot, final Task pTask) {
   ...
   * 
   */
  public static RobotExecutingUnlinkedTaskMatch newMatch(final Robot pRobot, final Task pTask) {
