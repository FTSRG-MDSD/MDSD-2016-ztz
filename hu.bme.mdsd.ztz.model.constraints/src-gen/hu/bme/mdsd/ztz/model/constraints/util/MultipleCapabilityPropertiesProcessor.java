...
/**
 * A match processor tailored for the hu.bme.mdsd.ztz.model.constraints.multipleCapabilityProperties pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MultipleCapabilityPropertiesProcessor implements IMatchProcessor<MultipleCapabilityPropertiesMatch> {
  /**
  ...
  @Override
  public void process(final MultipleCapabilityPropertiesMatch match) {
