...
public final class RobotHasTaskQuerySpecification extends BaseGeneratedEMFQuerySpecification<RobotHasTaskMatcher> {
  ...
  public RobotHasTaskMatch newMatch(final Object... parameters) {
    return RobotHasTaskMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.DynamicRobot) parameters[0], (hu.bme.mdsd.ztz.model.drone.Task) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var__virtual_0_, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/drone", "Robot", "tasks")));
