...
public final class NonPositiveParticipantsQuerySpecification extends BaseGeneratedEMFQuerySpecification<NonPositiveParticipantsMatcher> {
  ...
  public NonPositiveParticipantsMatch newMatch(final Object... parameters) {
    return NonPositiveParticipantsMatch.newMatch((hu.bme.mdsd.ztz.model.drone.TaskRequirement) parameters[0]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("requirement", "hu.bme.mdsd.ztz.model.drone.TaskRequirement"));
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_requirement), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.mdsd.hu/drone", "TaskRequirement")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_requirement, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.mdsd.hu/drone", "TaskRequirement", "participants")));
