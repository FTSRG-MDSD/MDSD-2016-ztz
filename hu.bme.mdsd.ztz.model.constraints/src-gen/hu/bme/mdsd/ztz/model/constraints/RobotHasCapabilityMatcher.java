...
/**
 * Generated pattern matcher API of the hu.bme.mdsd.ztz.model.constraints.robotHasCapability pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link RobotHasCapabilityMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see RobotHasCapabilityQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class RobotHasCapabilityMatcher extends BaseMatcher<RobotHasCapabilityMatch> {
  /**
   ...
   * 
   */
  public static RobotHasCapabilityMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    RobotHasCapabilityMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new RobotHasCapabilityMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(RobotHasCapabilityMatcher.class);
   ...
   */
  @Deprecated
  public RobotHasCapabilityMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public RobotHasCapabilityMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * 
   */
  public Set<Capability> getAllValuesOfcapability(final RobotHasCapabilityMatch partialMatch) {
   ...
   * 
   */
  public static IQuerySpecification<RobotHasCapabilityMatcher> querySpecification() throws IncQueryException {
