...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.sizeDimensionsNotCompatible pattern,
 * to be used in conjunction with {@link SizeDimensionsNotCompatibleMatcher}.
 * 
...
public abstract class SizeDimensionsNotCompatibleMatch extends BasePatternMatch {
  ...
  private SizeDimensionsNotCompatibleMatch(final Robot pRobot, final Size pSize) {
    this.fRobot = pRobot;
    this.fSize = pSize;
  }
  ...
  public List<String> parameterNames() {
    return SizeDimensionsNotCompatibleMatch.parameterNames;
  }
  ...
  @Override
  public SizeDimensionsNotCompatibleMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SizeDimensionsNotCompatibleMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SizeDimensionsNotCompatibleMatch other = (SizeDimensionsNotCompatibleMatch) obj;
  ...
  @Override
  public SizeDimensionsNotCompatibleQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SizeDimensionsNotCompatibleMatch newEmptyMatch() {
   ...
   * 
   */
  public static SizeDimensionsNotCompatibleMatch newMutableMatch(final Robot pRobot, final Size pSize) {
   ...
   * 
   */
  public static SizeDimensionsNotCompatibleMatch newMatch(final Robot pRobot, final Size pSize) {
    return new Immutable(pRobot, pSize);
  }
  
  private static final class Mutable extends SizeDimensionsNotCompatibleMatch {
  ...
  private static final class Immutable extends SizeDimensionsNotCompatibleMatch {
