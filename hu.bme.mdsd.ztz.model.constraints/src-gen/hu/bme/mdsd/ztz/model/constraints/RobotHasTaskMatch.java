...
public abstract class RobotHasTaskMatch extends BasePatternMatch {
  ...
  private RobotHasTaskMatch(final DynamicRobot pRobot, final Task pTask) {
    this.fRobot = pRobot;
    this.fTask = pTask;
  }
   ...
   * 
   */
  public static RobotHasTaskMatch newMutableMatch(final DynamicRobot pRobot, final Task pTask) {
   ...
   * 
   */
  public static RobotHasTaskMatch newMatch(final DynamicRobot pRobot, final Task pTask) {
