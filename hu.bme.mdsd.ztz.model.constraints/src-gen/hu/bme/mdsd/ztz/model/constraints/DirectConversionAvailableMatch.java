...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.directConversionAvailable pattern,
 * to be used in conjunction with {@link DirectConversionAvailableMatcher}.
 * 
...
public abstract class DirectConversionAvailableMatch extends BasePatternMatch {
  ...
  private DirectConversionAvailableMatch(final MeasureDimension pDim1, final MeasureDimension pDim2) {
    this.fDim1 = pDim1;
    this.fDim2 = pDim2;
  }
  ...
  public List<String> parameterNames() {
    return DirectConversionAvailableMatch.parameterNames;
  }
  ...
  @Override
  public DirectConversionAvailableMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof DirectConversionAvailableMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    DirectConversionAvailableMatch other = (DirectConversionAvailableMatch) obj;
  ...
  @Override
  public DirectConversionAvailableQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DirectConversionAvailableMatch newEmptyMatch() {
   ...
   * 
   */
  public static DirectConversionAvailableMatch newMutableMatch(final MeasureDimension pDim1, final MeasureDimension pDim2) {
   ...
   * 
   */
  public static DirectConversionAvailableMatch newMatch(final MeasureDimension pDim1, final MeasureDimension pDim2) {
    return new Immutable(pDim1, pDim2);
  }
  
  private static final class Mutable extends DirectConversionAvailableMatch {
  ...
  private static final class Immutable extends DirectConversionAvailableMatch {
