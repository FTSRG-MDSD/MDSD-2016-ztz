...
/**
 * A match processor tailored for the hu.bme.mdsd.ztz.model.constraints.collaborationNotSymmetric pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CollaborationNotSymmetricProcessor implements IMatchProcessor<CollaborationNotSymmetricMatch> {
  /**
  ...
  @Override
  public void process(final CollaborationNotSymmetricMatch match) {
