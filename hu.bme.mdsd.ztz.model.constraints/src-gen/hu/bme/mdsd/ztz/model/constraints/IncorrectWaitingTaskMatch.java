...
public abstract class IncorrectWaitingTaskMatch extends BasePatternMatch {
  ...
  private IncorrectWaitingTaskMatch(final Task pTask) {
    this.fTask = pTask;
  }
   ...
   * 
   */
  public static IncorrectWaitingTaskMatch newMutableMatch(final Task pTask) {
   ...
   * 
   */
  public static IncorrectWaitingTaskMatch newMatch(final Task pTask) {
