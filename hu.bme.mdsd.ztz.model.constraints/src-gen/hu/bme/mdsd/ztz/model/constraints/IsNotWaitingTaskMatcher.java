...
public class IsNotWaitingTaskMatcher extends BaseMatcher<IsNotWaitingTaskMatch> {
   ...
   * 
   */
  public Collection<IsNotWaitingTaskMatch> getAllMatches(final TaskExecution pTaskExecution) {
   ...
   * 
   */
  public IsNotWaitingTaskMatch getOneArbitraryMatch(final TaskExecution pTaskExecution) {
   ...
   * 
   */
  public void forEachMatch(final TaskExecution pTaskExecution, final IMatchProcessor<? super IsNotWaitingTaskMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final TaskExecution pTaskExecution, final IMatchProcessor<? super IsNotWaitingTaskMatch> processor) {
   ...
   * 
   */
  public IsNotWaitingTaskMatch newMatch(final TaskExecution pTaskExecution) {
    return IsNotWaitingTaskMatch.newMatch(pTaskExecution);
  }
  ...
  protected IsNotWaitingTaskMatch tupleToMatch(final Tuple t) {
    try {
    	return IsNotWaitingTaskMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.TaskExecution) t.get(POSITION_TASKEXECUTION));
  ...
  protected IsNotWaitingTaskMatch arrayToMatch(final Object[] match) {
    try {
    	return IsNotWaitingTaskMatch.newMatch((hu.bme.mdsd.ztz.model.behaviour.TaskExecution) match[POSITION_TASKEXECUTION]);
    } catch(ClassCastException e) {
  ...
  protected IsNotWaitingTaskMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return IsNotWaitingTaskMatch.newMutableMatch((hu.bme.mdsd.ztz.model.behaviour.TaskExecution) match[POSITION_TASKEXECUTION]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
