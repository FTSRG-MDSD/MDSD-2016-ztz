...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.circleRequirementReference pattern,
 * to be used in conjunction with {@link CircleRequirementReferenceMatcher}.
 * 
...
public abstract class CircleRequirementReferenceMatch extends BasePatternMatch {
  private TaskExecution fTaskExecution;
  
  private static List<String> parameterNames = makeImmutableList("taskExecution");
  
  private CircleRequirementReferenceMatch(final TaskExecution pTaskExecution) {
  ...
  public List<String> parameterNames() {
    return CircleRequirementReferenceMatch.parameterNames;
  }
  ...
  @Override
  public CircleRequirementReferenceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CircleRequirementReferenceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CircleRequirementReferenceMatch other = (CircleRequirementReferenceMatch) obj;
  ...
  @Override
  public CircleRequirementReferenceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CircleRequirementReferenceMatch newEmptyMatch() {
   ...
   * 
   */
  public static CircleRequirementReferenceMatch newMutableMatch(final TaskExecution pTaskExecution) {
   ...
   * 
   */
  public static CircleRequirementReferenceMatch newMatch(final TaskExecution pTaskExecution) {
    return new Immutable(pTaskExecution);
  }
  
  private static final class Mutable extends CircleRequirementReferenceMatch {
  ...
  private static final class Immutable extends CircleRequirementReferenceMatch {
