...
/**
 * Pattern-specific match representation of the hu.bme.mdsd.ztz.model.constraints.notCorrectlyLinkedCapabilityPropertiesToRobot pattern,
 * to be used in conjunction with {@link NotCorrectlyLinkedCapabilityPropertiesToRobotMatcher}.
 * 
...
public abstract class NotCorrectlyLinkedCapabilityPropertiesToRobotMatch extends BasePatternMatch {
  ...
  private NotCorrectlyLinkedCapabilityPropertiesToRobotMatch(final Robot pRobot, final Capability pCapability) {
    this.fRobot = pRobot;
  ...
  public List<String> parameterNames() {
    return NotCorrectlyLinkedCapabilityPropertiesToRobotMatch.parameterNames;
  }
  ...
  @Override
  public NotCorrectlyLinkedCapabilityPropertiesToRobotMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NotCorrectlyLinkedCapabilityPropertiesToRobotMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NotCorrectlyLinkedCapabilityPropertiesToRobotMatch other = (NotCorrectlyLinkedCapabilityPropertiesToRobotMatch) obj;
  ...
  @Override
  public NotCorrectlyLinkedCapabilityPropertiesToRobotQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NotCorrectlyLinkedCapabilityPropertiesToRobotMatch newEmptyMatch() {
   ...
   * 
   */
  public static NotCorrectlyLinkedCapabilityPropertiesToRobotMatch newMutableMatch(final Robot pRobot, final Capability pCapability) {
   ...
   * 
   */
  public static NotCorrectlyLinkedCapabilityPropertiesToRobotMatch newMatch(final Robot pRobot, final Capability pCapability) {
    return new Immutable(pRobot, pCapability);
  }
  
  private static final class Mutable extends NotCorrectlyLinkedCapabilityPropertiesToRobotMatch {
  ...
  private static final class Immutable extends NotCorrectlyLinkedCapabilityPropertiesToRobotMatch {
