		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConditionAccess().getCompareAlternatives_0_1_3_0(), "rule__Condition__CompareAlternatives_0_1_3_0");
					put(grammarAccess.getConditionAccess().getCompareAlternatives_1_3_0(), "rule__Condition__CompareAlternatives_1_3_0");
					put(grammarAccess.getConditionAccess().getCompareAlternatives_2_1_0(), "rule__Condition__CompareAlternatives_2_1_0");
					put(grammarAccess.getMeasureComparableAccess().getAlternatives(), "rule__MeasureComparable__Alternatives");
					...
					put(grammarAccess.getConditionalStatementAccess().getGroup_7(), "rule__ConditionalStatement__Group_7__0");
					put(grammarAccess.getSynchronousStatementAccess().getGroup(), "rule__SynchronousStatement__Group__0");
					put(grammarAccess.getActionDeclarationStatementAccess().getGroup(), "rule__ActionDeclarationStatement__Group__0");
					put(grammarAccess.getActionDeclarationStatementAccess().getGroup_2(), "rule__ActionDeclarationStatement__Group_2__0");
					...
					put(grammarAccess.getActionImplementationAccess().getGroup(), "rule__ActionImplementation__Group__0");
					...
					put(grammarAccess.getMeasureComparableAccess().getGroup_0(), "rule__MeasureComparable__Group_0__0");
					...
					put(grammarAccess.getConditionalStatementAccess().getConditionAssignment_2_1(), "rule__ConditionalStatement__ConditionAssignment_2_1");
					put(grammarAccess.getConditionalStatementAccess().getStatementsAssignment_5(), "rule__ConditionalStatement__StatementsAssignment_5");
					put(grammarAccess.getConditionalStatementAccess().getOtherStatementsAssignment_7_2(), "rule__ConditionalStatement__OtherStatementsAssignment_7_2");
					...
					put(grammarAccess.getActionDeclarationStatementAccess().getNameAssignment_1(), "rule__ActionDeclarationStatement__NameAssignment_1");
					put(grammarAccess.getActionDeclarationStatementAccess().getPropertiesAssignment_2_1(), "rule__ActionDeclarationStatement__PropertiesAssignment_2_1");
					...
					put(grammarAccess.getActionImplementationAccess().getDeclarationAssignment_0(), "rule__ActionImplementation__DeclarationAssignment_0");
					...
					put(grammarAccess.getConditionAccess().getLeftTaskAssignment_0_1_0(), "rule__Condition__LeftTaskAssignment_0_1_0");
					put(grammarAccess.getConditionAccess().getCompareAssignment_0_1_3(), "rule__Condition__CompareAssignment_0_1_3");
					put(grammarAccess.getConditionAccess().getRightStatusAssignment_0_1_4(), "rule__Condition__RightStatusAssignment_0_1_4");
					put(grammarAccess.getConditionAccess().getLeftRobotAssignment_1_0(), "rule__Condition__LeftRobotAssignment_1_0");
					put(grammarAccess.getConditionAccess().getCompareAssignment_1_3(), "rule__Condition__CompareAssignment_1_3");
					put(grammarAccess.getConditionAccess().getRightStatusAssignment_1_4(), "rule__Condition__RightStatusAssignment_1_4");
					put(grammarAccess.getConditionAccess().getLeftMeasureAssignment_2_0(), "rule__Condition__LeftMeasureAssignment_2_0");
					put(grammarAccess.getConditionAccess().getCompareAssignment_2_1(), "rule__Condition__CompareAssignment_2_1");
					put(grammarAccess.getConditionAccess().getRightMeasureAssignment_2_2(), "rule__Condition__RightMeasureAssignment_2_2");
					put(grammarAccess.getMeasureComparableAccess().getContainerAssignment_0_0(), "rule__MeasureComparable__ContainerAssignment_0_0");
					put(grammarAccess.getMeasureComparableAccess().getMemberAssignment_0_2(), "rule__MeasureComparable__MemberAssignment_0_2");
					put(grammarAccess.getMeasureComparableAccess().getValueAssignment_1(), "rule__MeasureComparable__ValueAssignment_1");
					...
					put(grammarAccess.getTaskExecutionAccess().getRequirementAssignment_5_1(), "rule__TaskExecution__RequirementAssignment_5_1");
					put(grammarAccess.getTaskRequirementAccess().getNameAssignment_2(), "rule__TaskRequirement__NameAssignment_2");
