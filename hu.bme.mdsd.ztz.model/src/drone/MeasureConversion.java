 ...
 * </p>
 * <ul>
 *   <li>{@link drone.MeasureConversion#getRate <em>Rate</em>}</li>
 *   <li>{@link drone.MeasureConversion#getDimension <em>Dimension</em>}</li>
 * </ul>
 *
 * @see drone.DronePackage#getMeasureConversion()
 * @model
 * @generated
 */
public interface MeasureConversion extends EObject {
         ...
         * @see #setRate(float)
         * @see drone.DronePackage#getMeasureConversion_Rate()
         * @model
         * @generated
         */
        float getRate();
        ...
        /**
         * Sets the value of the '{@link drone.MeasureConversion#getRate <em>Rate</em>}' attribute.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @see drone.DronePackage#getMeasureConversion_Dimension()
         * @model required="true"
         * @generated
         */
        ...
        /**
         * Sets the value of the '{@link drone.MeasureConversion#getDimension <em>Dimension</em>}' reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
