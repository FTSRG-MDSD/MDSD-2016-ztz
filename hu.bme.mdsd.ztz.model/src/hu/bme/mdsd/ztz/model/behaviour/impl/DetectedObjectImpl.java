 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mdsd.ztz.model.behaviour.impl.DetectedObjectImpl#getObject <em>Object</em>}</li>
 *   <li>{@link hu.bme.mdsd.ztz.model.behaviour.impl.DetectedObjectImpl#isObstacle <em>Obstacle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DetectedObjectImpl extends MinimalEObjectImpl.Container implements DetectedObject {
        ...
        protected EClass eStaticClass() {
                return BehaviourPackage.Literals.DETECTED_OBJECT;
        }
                ...
                if (object != null && object.eIsProxy()) {
                        ...
                        if (object != oldObject) {
                                if (eNotificationRequired())
                                        eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviourPackage.DETECTED_OBJECT__OBJECT, oldObject, object));
                        }
                }
                return object;
        }
        ...
        public void setObject(AreaObject newObject) {
                ...
                object = newObject;
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.DETECTED_OBJECT__OBJECT, oldObject, object));
        }
        ...
        public void setObstacle(boolean newObstacle) {
                ...
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.DETECTED_OBJECT__OBSTACLE, oldObstacle, obstacle));
        }
        ...
        public Object eGet(int featureID, boolean resolve, boolean coreType) {
                switch (featureID) {
                        case BehaviourPackage.DETECTED_OBJECT__OBJECT:
