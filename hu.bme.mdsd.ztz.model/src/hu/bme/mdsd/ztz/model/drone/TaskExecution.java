 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getExecutors <em>Executors</em>}</li>
 *   <li>{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getExecutionTime <em>Execution Time</em>}</li>
 *   <li>{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getStatus <em>Status</em>}</li>
 *   <li>{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getTask <em>Task</em>}</li>
 * </ul>
 *
 * @see hu.bme.mdsd.ztz.model.drone.DronePackage#getTaskExecution()
 * @model
 * @generated
 */
public interface TaskExecution extends EObject {
         ...
         * It is bidirectional and its opposite is '{@link hu.bme.mdsd.ztz.model.drone.Robot#getExecute <em>Execute</em>}'.
         * <!-- begin-user-doc -->
         * <p>
         ...
         * @see hu.bme.mdsd.ztz.model.drone.DronePackage#getTaskExecution_Executors()
         ...
         * @see hu.bme.mdsd.ztz.model.drone.DronePackage#getTaskExecution_ExecutionTime()
        ...
        /**
         * Sets the value of the '{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getExecutionTime <em>Execution Time</em>}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * The literals are from the enumeration {@link hu.bme.mdsd.ztz.model.drone.TaskExecutionStatus}.
         * <!-- begin-user-doc -->
         * <p>
         ...
         * @see hu.bme.mdsd.ztz.model.drone.DronePackage#getTaskExecution_Status()
        ...
        /**
         * Sets the value of the '{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getStatus <em>Status</em>}' attribute.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * It is bidirectional and its opposite is '{@link hu.bme.mdsd.ztz.model.drone.Task#getExecution <em>Execution</em>}'.
         * <!-- begin-user-doc -->
         * <p>
         ...
         * @see #setTask(Task)
         * @see hu.bme.mdsd.ztz.model.drone.DronePackage#getTaskExecution_Task()
        ...
        /**
         * Sets the value of the '{@link hu.bme.mdsd.ztz.model.drone.TaskExecution#getTask <em>Task</em>}' container reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
