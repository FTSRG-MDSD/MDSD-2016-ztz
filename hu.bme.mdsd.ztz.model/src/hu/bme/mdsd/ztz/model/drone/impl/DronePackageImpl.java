...
public class DronePackageImpl extends EPackageImpl implements DronePackage {
	 ...
	 * @generated
	 */
	public EReference getRobotMissionContainer_TemporalElements() {
		return (EReference)robotMissionContainerEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
		...
		createEReference(robotMissionContainerEClass, ROBOT_MISSION_CONTAINER__TEMPORAL_ELEMENTS);
	 ...
	 */
		...
		initEReference(getRobotMissionContainer_TemporalElements(), ecorePackage.getEObject(), null, "temporalElements", null, 0, -1, RobotMissionContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
