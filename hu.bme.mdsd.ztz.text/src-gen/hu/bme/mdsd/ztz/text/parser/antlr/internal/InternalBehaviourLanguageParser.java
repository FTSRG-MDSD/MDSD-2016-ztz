...
public class InternalBehaviourLanguageParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'import'", "'Declaration'", "'{'", "'DynamicRobots'", "','", "'}'", "'TaskExecutions'", "'TaskRequirements'", "'Keys'", "':'", "'if'", "'then'", "'else'", "'do'", "'->'", "'send'", "'know'", "'detect'", "'obstacle'", "'exec'", "'('", "')'", "'*'", "'=='", "'!='", "'status'", "'executionTime'", "'TaskRequirement'", "'participants'", "'taskExecution'", "'prerequisite'", "'requiredCapabilities'", "'properties'", "'capabilityProperties'", "'BehaviouralPropertyKeyContainer'", "'keys'", "'Property'", "'key'", "'value'", "'MeasureValue'", "'dimension'", "'CapabilityProperties'", "'capability'", "'-'", "'.'", "'E'", "'e'", "'PropertyKey'", "'StringValue'", "'Objects'", "'Follows'", "'Properties'", "'TTL'", "'Ready'", "'TurnedOff'", "'Waiting'", "'Executing'", "'Finished'", "'Suspended'", "'InProgress'"
    };
    ...
    // InternalBehaviourLanguage.g:1433:1: ruleTaskExecution returns [EObject current=null] : ( ( (lv_name_0_0= ruleEString ) ) otherlv_1= ':' ( (otherlv_2= RULE_ID ) ) otherlv_3= '{' (otherlv_4= 'status' ( (lv_status_5_0= ruleTaskExecutionStatus ) ) )? (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )? otherlv_8= '}' ) ;
    public final EObject ruleTaskExecution() throws RecognitionException {
        ...
        EObject lv_executionTime_7_0 = null;
        ...
        try {
            // InternalBehaviourLanguage.g:1439:2: ( ( ( (lv_name_0_0= ruleEString ) ) otherlv_1= ':' ( (otherlv_2= RULE_ID ) ) otherlv_3= '{' (otherlv_4= 'status' ( (lv_status_5_0= ruleTaskExecutionStatus ) ) )? (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )? otherlv_8= '}' ) )
            // InternalBehaviourLanguage.g:1440:2: ( ( (lv_name_0_0= ruleEString ) ) otherlv_1= ':' ( (otherlv_2= RULE_ID ) ) otherlv_3= '{' (otherlv_4= 'status' ( (lv_status_5_0= ruleTaskExecutionStatus ) ) )? (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )? otherlv_8= '}' )
            {
            // InternalBehaviourLanguage.g:1440:2: ( ( (lv_name_0_0= ruleEString ) ) otherlv_1= ':' ( (otherlv_2= RULE_ID ) ) otherlv_3= '{' (otherlv_4= 'status' ( (lv_status_5_0= ruleTaskExecutionStatus ) ) )? (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )? otherlv_8= '}' )
            // InternalBehaviourLanguage.g:1441:3: ( (lv_name_0_0= ruleEString ) ) otherlv_1= ':' ( (otherlv_2= RULE_ID ) ) otherlv_3= '{' (otherlv_4= 'status' ( (lv_status_5_0= ruleTaskExecutionStatus ) ) )? (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )? otherlv_8= '}'
            {
            ...
            // InternalBehaviourLanguage.g:1506:3: (otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) ) )?
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // InternalBehaviourLanguage.g:1507:4: otherlv_6= 'executionTime' ( (lv_executionTime_7_0= ruleMeasureValue ) )
                    {
                    ...
                    // InternalBehaviourLanguage.g:1511:4: ( (lv_executionTime_7_0= ruleMeasureValue ) )
                    // InternalBehaviourLanguage.g:1512:5: (lv_executionTime_7_0= ruleMeasureValue )
                    {
                    // InternalBehaviourLanguage.g:1512:5: (lv_executionTime_7_0= ruleMeasureValue )
                    // InternalBehaviourLanguage.g:1513:6: lv_executionTime_7_0= ruleMeasureValue
                    {
    ...
    // InternalBehaviourLanguage.g:1539:1: entryRuleTaskRequirement returns [EObject current=null] : iv_ruleTaskRequirement= ruleTaskRequirement EOF ;
    public final EObject entryRuleTaskRequirement() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1539:56: (iv_ruleTaskRequirement= ruleTaskRequirement EOF )
            // InternalBehaviourLanguage.g:1540:2: iv_ruleTaskRequirement= ruleTaskRequirement EOF
            {
    ...
    public final EObject ruleTaskRequirement() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1552:2: ( (otherlv_0= 'TaskRequirement' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'participants' ( (lv_participants_4_0= ruleEInt ) ) otherlv_5= 'taskExecution' ( (otherlv_6= RULE_ID ) ) (otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) ) )? (otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')' )? (otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}' )? (otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}' )? otherlv_27= '}' ) )
            // InternalBehaviourLanguage.g:1553:2: (otherlv_0= 'TaskRequirement' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'participants' ( (lv_participants_4_0= ruleEInt ) ) otherlv_5= 'taskExecution' ( (otherlv_6= RULE_ID ) ) (otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) ) )? (otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')' )? (otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}' )? (otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}' )? otherlv_27= '}' )
            {
            // InternalBehaviourLanguage.g:1553:2: (otherlv_0= 'TaskRequirement' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'participants' ( (lv_participants_4_0= ruleEInt ) ) otherlv_5= 'taskExecution' ( (otherlv_6= RULE_ID ) ) (otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) ) )? (otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')' )? (otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}' )? (otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}' )? otherlv_27= '}' )
            // InternalBehaviourLanguage.g:1554:3: otherlv_0= 'TaskRequirement' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'participants' ( (lv_participants_4_0= ruleEInt ) ) otherlv_5= 'taskExecution' ( (otherlv_6= RULE_ID ) ) (otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) ) )? (otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')' )? (otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}' )? (otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}' )? otherlv_27= '}'
            {
            ...
            // InternalBehaviourLanguage.g:1558:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBehaviourLanguage.g:1559:4: (lv_name_1_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:1559:4: (lv_name_1_0= ruleEString )
            // InternalBehaviourLanguage.g:1560:5: lv_name_1_0= ruleEString
            {
            ...
            otherlv_3=(Token)match(input,39,FOLLOW_39); 

            			newLeafNode(otherlv_3, grammarAccess.getTaskRequirementAccess().getParticipantsKeyword_3());
            		
            // InternalBehaviourLanguage.g:1585:3: ( (lv_participants_4_0= ruleEInt ) )
            // InternalBehaviourLanguage.g:1586:4: (lv_participants_4_0= ruleEInt )
            {
            // InternalBehaviourLanguage.g:1586:4: (lv_participants_4_0= ruleEInt )
            // InternalBehaviourLanguage.g:1587:5: lv_participants_4_0= ruleEInt
            {
            ...
            // InternalBehaviourLanguage.g:1608:3: ( (otherlv_6= RULE_ID ) )
            // InternalBehaviourLanguage.g:1609:4: (otherlv_6= RULE_ID )
            {
            // InternalBehaviourLanguage.g:1609:4: (otherlv_6= RULE_ID )
            // InternalBehaviourLanguage.g:1610:5: otherlv_6= RULE_ID
            {
            ...
            // InternalBehaviourLanguage.g:1621:3: (otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) ) )?
            int alt25=2;
            ...
            switch (alt25) {
                case 1 :
                    // InternalBehaviourLanguage.g:1622:4: otherlv_7= 'prerequisite' ( (otherlv_8= RULE_ID ) )
                    {
                    ...
                    // InternalBehaviourLanguage.g:1626:4: ( (otherlv_8= RULE_ID ) )
                    // InternalBehaviourLanguage.g:1627:5: (otherlv_8= RULE_ID )
                    {
                    // InternalBehaviourLanguage.g:1627:5: (otherlv_8= RULE_ID )
                    // InternalBehaviourLanguage.g:1628:6: otherlv_8= RULE_ID
                    {
            ...
            // InternalBehaviourLanguage.g:1640:3: (otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')' )?
            int alt27=2;
            ...
            switch (alt27) {
                case 1 :
                    // InternalBehaviourLanguage.g:1641:4: otherlv_9= 'requiredCapabilities' otherlv_10= '(' ( (otherlv_11= RULE_ID ) ) (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )* otherlv_14= ')'
                    {
                    otherlv_9=(Token)match(input,42,FOLLOW_43); 
                    ...
                    // InternalBehaviourLanguage.g:1649:4: ( (otherlv_11= RULE_ID ) )
                    // InternalBehaviourLanguage.g:1650:5: (otherlv_11= RULE_ID )
                    {
                    // InternalBehaviourLanguage.g:1650:5: (otherlv_11= RULE_ID )
                    // InternalBehaviourLanguage.g:1651:6: otherlv_11= RULE_ID
                    {
                    ...
                    // InternalBehaviourLanguage.g:1662:4: (otherlv_12= ',' ( (otherlv_13= RULE_ID ) ) )*
                    loop26:
                    do {
                        int alt26=2;
                        ...
                        switch (alt26) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:1663:5: otherlv_12= ',' ( (otherlv_13= RULE_ID ) )
                    	    {
                    	    ...
                    	    // InternalBehaviourLanguage.g:1667:5: ( (otherlv_13= RULE_ID ) )
                    	    // InternalBehaviourLanguage.g:1668:6: (otherlv_13= RULE_ID )
                    	    {
                    	    // InternalBehaviourLanguage.g:1668:6: (otherlv_13= RULE_ID )
                    	    // InternalBehaviourLanguage.g:1669:7: otherlv_13= RULE_ID
                    	    {
                    ...
                    otherlv_14=(Token)match(input,32,FOLLOW_44); 
            ...
            // InternalBehaviourLanguage.g:1686:3: (otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}' )?
            int alt29=2;
            ...
            switch (alt29) {
                case 1 :
                    // InternalBehaviourLanguage.g:1687:4: otherlv_15= 'properties' otherlv_16= '{' ( (lv_properties_17_0= ruleProperty ) ) (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )* otherlv_20= '}'
                    {
                    ...
                    // InternalBehaviourLanguage.g:1695:4: ( (lv_properties_17_0= ruleProperty ) )
                    // InternalBehaviourLanguage.g:1696:5: (lv_properties_17_0= ruleProperty )
                    {
                    // InternalBehaviourLanguage.g:1696:5: (lv_properties_17_0= ruleProperty )
                    // InternalBehaviourLanguage.g:1697:6: lv_properties_17_0= ruleProperty
                    {
                    ...
                    // InternalBehaviourLanguage.g:1714:4: (otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) ) )*
                    loop28:
                    do {
                        int alt28=2;
                        ...
                        switch (alt28) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:1715:5: otherlv_18= ',' ( (lv_properties_19_0= ruleProperty ) )
                    	    {
                    	    otherlv_18=(Token)match(input,15,FOLLOW_45); 

                    	    					newLeafNode(otherlv_18, grammarAccess.getTaskRequirementAccess().getCommaKeyword_9_3_0());
                    	    				
                    	    // InternalBehaviourLanguage.g:1719:5: ( (lv_properties_19_0= ruleProperty ) )
                    	    // InternalBehaviourLanguage.g:1720:6: (lv_properties_19_0= ruleProperty )
                    	    {
                    	    // InternalBehaviourLanguage.g:1720:6: (lv_properties_19_0= ruleProperty )
                    	    // InternalBehaviourLanguage.g:1721:7: lv_properties_19_0= ruleProperty
                    	    {
                    ...
                    otherlv_20=(Token)match(input,16,FOLLOW_46); 
            ...
            // InternalBehaviourLanguage.g:1744:3: (otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}' )?
            int alt31=2;
            ...
            switch (alt31) {
                case 1 :
                    // InternalBehaviourLanguage.g:1745:4: otherlv_21= 'capabilityProperties' otherlv_22= '{' ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) ) (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )* otherlv_26= '}'
                    {
                    otherlv_21=(Token)match(input,44,FOLLOW_6); 

                    				newLeafNode(otherlv_21, grammarAccess.getTaskRequirementAccess().getCapabilityPropertiesKeyword_10_0());
                    			
                    otherlv_22=(Token)match(input,13,FOLLOW_47); 

                    				newLeafNode(otherlv_22, grammarAccess.getTaskRequirementAccess().getLeftCurlyBracketKeyword_10_1());
                    			
                    // InternalBehaviourLanguage.g:1753:4: ( (lv_capabilityProperties_23_0= ruleCapabilityProperties ) )
                    // InternalBehaviourLanguage.g:1754:5: (lv_capabilityProperties_23_0= ruleCapabilityProperties )
                    {
                    // InternalBehaviourLanguage.g:1754:5: (lv_capabilityProperties_23_0= ruleCapabilityProperties )
                    // InternalBehaviourLanguage.g:1755:6: lv_capabilityProperties_23_0= ruleCapabilityProperties
                    {
                    ...
                    // InternalBehaviourLanguage.g:1772:4: (otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) ) )*
                    loop30:
                    do {
                        int alt30=2;
                        ...
                        switch (alt30) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:1773:5: otherlv_24= ',' ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) )
                    	    {
                    	    otherlv_24=(Token)match(input,15,FOLLOW_47); 

                    	    					newLeafNode(otherlv_24, grammarAccess.getTaskRequirementAccess().getCommaKeyword_10_3_0());
                    	    				
                    	    // InternalBehaviourLanguage.g:1777:5: ( (lv_capabilityProperties_25_0= ruleCapabilityProperties ) )
                    	    // InternalBehaviourLanguage.g:1778:6: (lv_capabilityProperties_25_0= ruleCapabilityProperties )
                    	    {
                    	    // InternalBehaviourLanguage.g:1778:6: (lv_capabilityProperties_25_0= ruleCapabilityProperties )
                    	    // InternalBehaviourLanguage.g:1779:7: lv_capabilityProperties_25_0= ruleCapabilityProperties
                    	    {
    ...
    // InternalBehaviourLanguage.g:1810:1: entryRuleBehaviouralPropertyKeyContainer returns [EObject current=null] : iv_ruleBehaviouralPropertyKeyContainer= ruleBehaviouralPropertyKeyContainer EOF ;
    public final EObject entryRuleBehaviouralPropertyKeyContainer() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1810:72: (iv_ruleBehaviouralPropertyKeyContainer= ruleBehaviouralPropertyKeyContainer EOF )
            // InternalBehaviourLanguage.g:1811:2: iv_ruleBehaviouralPropertyKeyContainer= ruleBehaviouralPropertyKeyContainer EOF
            {
    ...
    // InternalBehaviourLanguage.g:1817:1: ruleBehaviouralPropertyKeyContainer returns [EObject current=null] : ( () otherlv_1= 'BehaviouralPropertyKeyContainer' ( (lv_name_2_0= ruleEString ) ) otherlv_3= '{' (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )? otherlv_10= '}' ) ;
    public final EObject ruleBehaviouralPropertyKeyContainer() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1823:2: ( ( () otherlv_1= 'BehaviouralPropertyKeyContainer' ( (lv_name_2_0= ruleEString ) ) otherlv_3= '{' (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )? otherlv_10= '}' ) )
            // InternalBehaviourLanguage.g:1824:2: ( () otherlv_1= 'BehaviouralPropertyKeyContainer' ( (lv_name_2_0= ruleEString ) ) otherlv_3= '{' (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )? otherlv_10= '}' )
            {
            // InternalBehaviourLanguage.g:1824:2: ( () otherlv_1= 'BehaviouralPropertyKeyContainer' ( (lv_name_2_0= ruleEString ) ) otherlv_3= '{' (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )? otherlv_10= '}' )
            // InternalBehaviourLanguage.g:1825:3: () otherlv_1= 'BehaviouralPropertyKeyContainer' ( (lv_name_2_0= ruleEString ) ) otherlv_3= '{' (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )? otherlv_10= '}'
            {
            // InternalBehaviourLanguage.g:1825:3: ()
            // InternalBehaviourLanguage.g:1826:4: 
            {
            ...
            // InternalBehaviourLanguage.g:1836:3: ( (lv_name_2_0= ruleEString ) )
            // InternalBehaviourLanguage.g:1837:4: (lv_name_2_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:1837:4: (lv_name_2_0= ruleEString )
            // InternalBehaviourLanguage.g:1838:5: lv_name_2_0= ruleEString
            {
            ...
            // InternalBehaviourLanguage.g:1859:3: (otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}' )?
            int alt33=2;
            ...
            switch (alt33) {
                case 1 :
                    // InternalBehaviourLanguage.g:1860:4: otherlv_4= 'keys' otherlv_5= '{' ( (lv_keys_6_0= rulePropertyKey ) ) (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )* otherlv_9= '}'
                    {
                    ...
                    otherlv_5=(Token)match(input,13,FOLLOW_49); 

                    				newLeafNode(otherlv_5, grammarAccess.getBehaviouralPropertyKeyContainerAccess().getLeftCurlyBracketKeyword_4_1());
                    			
                    // InternalBehaviourLanguage.g:1868:4: ( (lv_keys_6_0= rulePropertyKey ) )
                    // InternalBehaviourLanguage.g:1869:5: (lv_keys_6_0= rulePropertyKey )
                    {
                    // InternalBehaviourLanguage.g:1869:5: (lv_keys_6_0= rulePropertyKey )
                    // InternalBehaviourLanguage.g:1870:6: lv_keys_6_0= rulePropertyKey
                    {
                    ...
                    // InternalBehaviourLanguage.g:1887:4: (otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) ) )*
                    loop32:
                    do {
                        int alt32=2;
                        ...
                        switch (alt32) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:1888:5: otherlv_7= ',' ( (lv_keys_8_0= rulePropertyKey ) )
                    	    {
                    	    otherlv_7=(Token)match(input,15,FOLLOW_49); 

                    	    					newLeafNode(otherlv_7, grammarAccess.getBehaviouralPropertyKeyContainerAccess().getCommaKeyword_4_3_0());
                    	    				
                    	    // InternalBehaviourLanguage.g:1892:5: ( (lv_keys_8_0= rulePropertyKey ) )
                    	    // InternalBehaviourLanguage.g:1893:6: (lv_keys_8_0= rulePropertyKey )
                    	    {
                    	    // InternalBehaviourLanguage.g:1893:6: (lv_keys_8_0= rulePropertyKey )
                    	    // InternalBehaviourLanguage.g:1894:7: lv_keys_8_0= rulePropertyKey
                    	    {
    ...
    // InternalBehaviourLanguage.g:1925:1: entryRuleEString returns [String current=null] : iv_ruleEString= ruleEString EOF ;
    public final String entryRuleEString() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1925:47: (iv_ruleEString= ruleEString EOF )
            // InternalBehaviourLanguage.g:1926:2: iv_ruleEString= ruleEString EOF
            {
    ...
    // InternalBehaviourLanguage.g:1932:1: ruleEString returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID ) ;
    public final AntlrDatatypeRuleToken ruleEString() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1938:2: ( (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID ) )
            // InternalBehaviourLanguage.g:1939:2: (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID )
            {
            // InternalBehaviourLanguage.g:1939:2: (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID )
            int alt34=2;
            ...
            switch (alt34) {
                case 1 :
                    // InternalBehaviourLanguage.g:1940:3: this_STRING_0= RULE_STRING
                    {
                    ...
                    break;
                case 2 :
                    // InternalBehaviourLanguage.g:1948:3: this_ID_1= RULE_ID
                    {
    ...
    // InternalBehaviourLanguage.g:1959:1: entryRuleRobotCollaboration returns [EObject current=null] : iv_ruleRobotCollaboration= ruleRobotCollaboration EOF ;
    public final EObject entryRuleRobotCollaboration() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1959:59: (iv_ruleRobotCollaboration= ruleRobotCollaboration EOF )
            // InternalBehaviourLanguage.g:1960:2: iv_ruleRobotCollaboration= ruleRobotCollaboration EOF
            {
    ...
    // InternalBehaviourLanguage.g:1966:1: ruleRobotCollaboration returns [EObject current=null] : ( () ( (otherlv_1= RULE_ID ) ) (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )? ) ;
    public final EObject ruleRobotCollaboration() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:1972:2: ( ( () ( (otherlv_1= RULE_ID ) ) (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )? ) )
            // InternalBehaviourLanguage.g:1973:2: ( () ( (otherlv_1= RULE_ID ) ) (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )? )
            {
            // InternalBehaviourLanguage.g:1973:2: ( () ( (otherlv_1= RULE_ID ) ) (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )? )
            // InternalBehaviourLanguage.g:1974:3: () ( (otherlv_1= RULE_ID ) ) (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )?
            {
            // InternalBehaviourLanguage.g:1974:3: ()
            // InternalBehaviourLanguage.g:1975:4: 
            {
            ...
            // InternalBehaviourLanguage.g:1981:3: ( (otherlv_1= RULE_ID ) )
            // InternalBehaviourLanguage.g:1982:4: (otherlv_1= RULE_ID )
            {
            // InternalBehaviourLanguage.g:1982:4: (otherlv_1= RULE_ID )
            // InternalBehaviourLanguage.g:1983:5: otherlv_1= RULE_ID
            {
            ...
            // InternalBehaviourLanguage.g:1994:3: (otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}' )?
            int alt36=2;
            ...
            switch (alt36) {
                case 1 :
                    // InternalBehaviourLanguage.g:1995:4: otherlv_2= 'properties' otherlv_3= '{' ( (lv_properties_4_0= ruleProperty ) ) (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )* otherlv_7= '}'
                    {
                    ...
                    // InternalBehaviourLanguage.g:2003:4: ( (lv_properties_4_0= ruleProperty ) )
                    // InternalBehaviourLanguage.g:2004:5: (lv_properties_4_0= ruleProperty )
                    {
                    // InternalBehaviourLanguage.g:2004:5: (lv_properties_4_0= ruleProperty )
                    // InternalBehaviourLanguage.g:2005:6: lv_properties_4_0= ruleProperty
                    {
                    ...
                    // InternalBehaviourLanguage.g:2022:4: (otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) ) )*
                    loop35:
                    do {
                        int alt35=2;
                        ...
                        switch (alt35) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:2023:5: otherlv_5= ',' ( (lv_properties_6_0= ruleProperty ) )
                    	    {
                    	    ...
                    	    // InternalBehaviourLanguage.g:2027:5: ( (lv_properties_6_0= ruleProperty ) )
                    	    // InternalBehaviourLanguage.g:2028:6: (lv_properties_6_0= ruleProperty )
                    	    {
                    	    // InternalBehaviourLanguage.g:2028:6: (lv_properties_6_0= ruleProperty )
                    	    // InternalBehaviourLanguage.g:2029:7: lv_properties_6_0= ruleProperty
                    	    {
    ...
    // InternalBehaviourLanguage.g:2056:1: entryRuleAction_Impl returns [EObject current=null] : iv_ruleAction_Impl= ruleAction_Impl EOF ;
    public final EObject entryRuleAction_Impl() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2056:52: (iv_ruleAction_Impl= ruleAction_Impl EOF )
            // InternalBehaviourLanguage.g:2057:2: iv_ruleAction_Impl= ruleAction_Impl EOF
            {
    ...
    // InternalBehaviourLanguage.g:2063:1: ruleAction_Impl returns [EObject current=null] : ( () ( (lv_name_1_0= ruleEString ) ) (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )? (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )? ) ;
    public final EObject ruleAction_Impl() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2069:2: ( ( () ( (lv_name_1_0= ruleEString ) ) (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )? (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )? ) )
            // InternalBehaviourLanguage.g:2070:2: ( () ( (lv_name_1_0= ruleEString ) ) (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )? (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )? )
            {
            // InternalBehaviourLanguage.g:2070:2: ( () ( (lv_name_1_0= ruleEString ) ) (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )? (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )? )
            // InternalBehaviourLanguage.g:2071:3: () ( (lv_name_1_0= ruleEString ) ) (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )? (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )?
            {
            // InternalBehaviourLanguage.g:2071:3: ()
            // InternalBehaviourLanguage.g:2072:4: 
            {
            ...
            // InternalBehaviourLanguage.g:2078:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBehaviourLanguage.g:2079:4: (lv_name_1_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:2079:4: (lv_name_1_0= ruleEString )
            // InternalBehaviourLanguage.g:2080:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBehaviourLanguage.g:2097:3: (otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')' )?
            int alt37=2;
            ...
            switch (alt37) {
                case 1 :
                    // InternalBehaviourLanguage.g:2098:4: otherlv_2= '(' ( (otherlv_3= RULE_ID ) ) otherlv_4= ')'
                    {
                    ...
                    // InternalBehaviourLanguage.g:2102:4: ( (otherlv_3= RULE_ID ) )
                    // InternalBehaviourLanguage.g:2103:5: (otherlv_3= RULE_ID )
                    {
                    // InternalBehaviourLanguage.g:2103:5: (otherlv_3= RULE_ID )
                    // InternalBehaviourLanguage.g:2104:6: otherlv_3= RULE_ID
                    {
                    ...
                    otherlv_4=(Token)match(input,32,FOLLOW_50); 
            ...
            // InternalBehaviourLanguage.g:2120:3: (otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}' )?
            int alt39=2;
            ...
            switch (alt39) {
                case 1 :
                    // InternalBehaviourLanguage.g:2121:4: otherlv_5= 'properties' otherlv_6= '{' ( (lv_properties_7_0= ruleProperty ) ) (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )* otherlv_10= '}'
                    {
                    otherlv_5=(Token)match(input,43,FOLLOW_6); 

                    				newLeafNode(otherlv_5, grammarAccess.getAction_ImplAccess().getPropertiesKeyword_3_0());
                    			
                    otherlv_6=(Token)match(input,13,FOLLOW_45); 

                    				newLeafNode(otherlv_6, grammarAccess.getAction_ImplAccess().getLeftCurlyBracketKeyword_3_1());
                    			
                    // InternalBehaviourLanguage.g:2129:4: ( (lv_properties_7_0= ruleProperty ) )
                    // InternalBehaviourLanguage.g:2130:5: (lv_properties_7_0= ruleProperty )
                    {
                    // InternalBehaviourLanguage.g:2130:5: (lv_properties_7_0= ruleProperty )
                    // InternalBehaviourLanguage.g:2131:6: lv_properties_7_0= ruleProperty
                    {
                    ...
                    // InternalBehaviourLanguage.g:2148:4: (otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) ) )*
                    loop38:
                    do {
                        int alt38=2;
                        ...
                        switch (alt38) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:2149:5: otherlv_8= ',' ( (lv_properties_9_0= ruleProperty ) )
                    	    {
                    	    otherlv_8=(Token)match(input,15,FOLLOW_45); 

                    	    					newLeafNode(otherlv_8, grammarAccess.getAction_ImplAccess().getCommaKeyword_3_3_0());
                    	    				
                    	    // InternalBehaviourLanguage.g:2153:5: ( (lv_properties_9_0= ruleProperty ) )
                    	    // InternalBehaviourLanguage.g:2154:6: (lv_properties_9_0= ruleProperty )
                    	    {
                    	    // InternalBehaviourLanguage.g:2154:6: (lv_properties_9_0= ruleProperty )
                    	    // InternalBehaviourLanguage.g:2155:7: lv_properties_9_0= ruleProperty
                    	    {
    ...
    // InternalBehaviourLanguage.g:2182:1: entryRuleProperty returns [EObject current=null] : iv_ruleProperty= ruleProperty EOF ;
    public final EObject entryRuleProperty() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2182:49: (iv_ruleProperty= ruleProperty EOF )
            // InternalBehaviourLanguage.g:2183:2: iv_ruleProperty= ruleProperty EOF
            {
    ...
    // InternalBehaviourLanguage.g:2189:1: ruleProperty returns [EObject current=null] : (otherlv_0= 'Property' otherlv_1= '{' otherlv_2= 'key' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'value' ( (lv_value_5_0= rulePropertyValue ) ) otherlv_6= '}' ) ;
    public final EObject ruleProperty() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2195:2: ( (otherlv_0= 'Property' otherlv_1= '{' otherlv_2= 'key' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'value' ( (lv_value_5_0= rulePropertyValue ) ) otherlv_6= '}' ) )
            // InternalBehaviourLanguage.g:2196:2: (otherlv_0= 'Property' otherlv_1= '{' otherlv_2= 'key' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'value' ( (lv_value_5_0= rulePropertyValue ) ) otherlv_6= '}' )
            {
            // InternalBehaviourLanguage.g:2196:2: (otherlv_0= 'Property' otherlv_1= '{' otherlv_2= 'key' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'value' ( (lv_value_5_0= rulePropertyValue ) ) otherlv_6= '}' )
            // InternalBehaviourLanguage.g:2197:3: otherlv_0= 'Property' otherlv_1= '{' otherlv_2= 'key' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'value' ( (lv_value_5_0= rulePropertyValue ) ) otherlv_6= '}'
            {
            ...
            // InternalBehaviourLanguage.g:2209:3: ( (otherlv_3= RULE_ID ) )
            // InternalBehaviourLanguage.g:2210:4: (otherlv_3= RULE_ID )
            {
            // InternalBehaviourLanguage.g:2210:4: (otherlv_3= RULE_ID )
            // InternalBehaviourLanguage.g:2211:5: otherlv_3= RULE_ID
            {
            ...
            otherlv_4=(Token)match(input,49,FOLLOW_55); 

            			newLeafNode(otherlv_4, grammarAccess.getPropertyAccess().getValueKeyword_4());
            		
            // InternalBehaviourLanguage.g:2226:3: ( (lv_value_5_0= rulePropertyValue ) )
            // InternalBehaviourLanguage.g:2227:4: (lv_value_5_0= rulePropertyValue )
            {
            // InternalBehaviourLanguage.g:2227:4: (lv_value_5_0= rulePropertyValue )
            // InternalBehaviourLanguage.g:2228:5: lv_value_5_0= rulePropertyValue
            {
    ...
    // InternalBehaviourLanguage.g:2253:1: entryRuleMeasureValue returns [EObject current=null] : iv_ruleMeasureValue= ruleMeasureValue EOF ;
    public final EObject entryRuleMeasureValue() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2253:53: (iv_ruleMeasureValue= ruleMeasureValue EOF )
            // InternalBehaviourLanguage.g:2254:2: iv_ruleMeasureValue= ruleMeasureValue EOF
            {
    ...
    // InternalBehaviourLanguage.g:2260:1: ruleMeasureValue returns [EObject current=null] : (otherlv_0= 'MeasureValue' otherlv_1= '{' (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )? otherlv_4= 'dimension' ( (otherlv_5= RULE_ID ) ) otherlv_6= '}' ) ;
    public final EObject ruleMeasureValue() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2266:2: ( (otherlv_0= 'MeasureValue' otherlv_1= '{' (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )? otherlv_4= 'dimension' ( (otherlv_5= RULE_ID ) ) otherlv_6= '}' ) )
            // InternalBehaviourLanguage.g:2267:2: (otherlv_0= 'MeasureValue' otherlv_1= '{' (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )? otherlv_4= 'dimension' ( (otherlv_5= RULE_ID ) ) otherlv_6= '}' )
            {
            // InternalBehaviourLanguage.g:2267:2: (otherlv_0= 'MeasureValue' otherlv_1= '{' (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )? otherlv_4= 'dimension' ( (otherlv_5= RULE_ID ) ) otherlv_6= '}' )
            // InternalBehaviourLanguage.g:2268:3: otherlv_0= 'MeasureValue' otherlv_1= '{' (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )? otherlv_4= 'dimension' ( (otherlv_5= RULE_ID ) ) otherlv_6= '}'
            {
            ...
            // InternalBehaviourLanguage.g:2276:3: (otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) ) )?
            int alt40=2;
            ...
            switch (alt40) {
                case 1 :
                    // InternalBehaviourLanguage.g:2277:4: otherlv_2= 'value' ( (lv_value_3_0= ruleEFloat ) )
                    {
                    otherlv_2=(Token)match(input,49,FOLLOW_57); 

                    				newLeafNode(otherlv_2, grammarAccess.getMeasureValueAccess().getValueKeyword_2_0());
                    			
                    // InternalBehaviourLanguage.g:2281:4: ( (lv_value_3_0= ruleEFloat ) )
                    // InternalBehaviourLanguage.g:2282:5: (lv_value_3_0= ruleEFloat )
                    {
                    // InternalBehaviourLanguage.g:2282:5: (lv_value_3_0= ruleEFloat )
                    // InternalBehaviourLanguage.g:2283:6: lv_value_3_0= ruleEFloat
                    {
            ...
            // InternalBehaviourLanguage.g:2305:3: ( (otherlv_5= RULE_ID ) )
            // InternalBehaviourLanguage.g:2306:4: (otherlv_5= RULE_ID )
            {
            // InternalBehaviourLanguage.g:2306:4: (otherlv_5= RULE_ID )
            // InternalBehaviourLanguage.g:2307:5: otherlv_5= RULE_ID
            {
    ...
    // InternalBehaviourLanguage.g:2326:1: entryRuleCapabilityProperties returns [EObject current=null] : iv_ruleCapabilityProperties= ruleCapabilityProperties EOF ;
    public final EObject entryRuleCapabilityProperties() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2326:61: (iv_ruleCapabilityProperties= ruleCapabilityProperties EOF )
            // InternalBehaviourLanguage.g:2327:2: iv_ruleCapabilityProperties= ruleCapabilityProperties EOF
            {
    ...
    // InternalBehaviourLanguage.g:2333:1: ruleCapabilityProperties returns [EObject current=null] : (otherlv_0= 'CapabilityProperties' otherlv_1= '{' otherlv_2= 'capability' ( (otherlv_3= RULE_ID ) ) (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )? otherlv_10= '}' ) ;
    public final EObject ruleCapabilityProperties() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2339:2: ( (otherlv_0= 'CapabilityProperties' otherlv_1= '{' otherlv_2= 'capability' ( (otherlv_3= RULE_ID ) ) (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )? otherlv_10= '}' ) )
            // InternalBehaviourLanguage.g:2340:2: (otherlv_0= 'CapabilityProperties' otherlv_1= '{' otherlv_2= 'capability' ( (otherlv_3= RULE_ID ) ) (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )? otherlv_10= '}' )
            {
            // InternalBehaviourLanguage.g:2340:2: (otherlv_0= 'CapabilityProperties' otherlv_1= '{' otherlv_2= 'capability' ( (otherlv_3= RULE_ID ) ) (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )? otherlv_10= '}' )
            // InternalBehaviourLanguage.g:2341:3: otherlv_0= 'CapabilityProperties' otherlv_1= '{' otherlv_2= 'capability' ( (otherlv_3= RULE_ID ) ) (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )? otherlv_10= '}'
            {
            ...
            // InternalBehaviourLanguage.g:2353:3: ( (otherlv_3= RULE_ID ) )
            // InternalBehaviourLanguage.g:2354:4: (otherlv_3= RULE_ID )
            {
            // InternalBehaviourLanguage.g:2354:4: (otherlv_3= RULE_ID )
            // InternalBehaviourLanguage.g:2355:5: otherlv_3= RULE_ID
            {
            ...
            // InternalBehaviourLanguage.g:2366:3: (otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}' )?
            int alt42=2;
            ...
            switch (alt42) {
                case 1 :
                    // InternalBehaviourLanguage.g:2367:4: otherlv_4= 'properties' otherlv_5= '{' ( (lv_properties_6_0= ruleProperty ) ) (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )* otherlv_9= '}'
                    {
                    ...
                    // InternalBehaviourLanguage.g:2375:4: ( (lv_properties_6_0= ruleProperty ) )
                    // InternalBehaviourLanguage.g:2376:5: (lv_properties_6_0= ruleProperty )
                    {
                    // InternalBehaviourLanguage.g:2376:5: (lv_properties_6_0= ruleProperty )
                    // InternalBehaviourLanguage.g:2377:6: lv_properties_6_0= ruleProperty
                    {
                    ...
                    // InternalBehaviourLanguage.g:2394:4: (otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) ) )*
                    loop41:
                    do {
                        int alt41=2;
                        ...
                        switch (alt41) {
                    	case 1 :
                    	    // InternalBehaviourLanguage.g:2395:5: otherlv_7= ',' ( (lv_properties_8_0= ruleProperty ) )
                    	    {
                    	    ...
                    	    // InternalBehaviourLanguage.g:2399:5: ( (lv_properties_8_0= ruleProperty ) )
                    	    // InternalBehaviourLanguage.g:2400:6: (lv_properties_8_0= ruleProperty )
                    	    {
                    	    // InternalBehaviourLanguage.g:2400:6: (lv_properties_8_0= ruleProperty )
                    	    // InternalBehaviourLanguage.g:2401:7: lv_properties_8_0= ruleProperty
                    	    {
    ...
    // InternalBehaviourLanguage.g:2432:1: entryRuleEFloat returns [String current=null] : iv_ruleEFloat= ruleEFloat EOF ;
    public final String entryRuleEFloat() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2432:46: (iv_ruleEFloat= ruleEFloat EOF )
            // InternalBehaviourLanguage.g:2433:2: iv_ruleEFloat= ruleEFloat EOF
            {
    ...
    // InternalBehaviourLanguage.g:2439:1: ruleEFloat returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? ) ;
    public final AntlrDatatypeRuleToken ruleEFloat() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2445:2: ( ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? ) )
            // InternalBehaviourLanguage.g:2446:2: ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? )
            {
            // InternalBehaviourLanguage.g:2446:2: ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? )
            // InternalBehaviourLanguage.g:2447:3: (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )?
            {
            // InternalBehaviourLanguage.g:2447:3: (kw= '-' )?
            int alt43=2;
            ...
            switch (alt43) {
                case 1 :
                    // InternalBehaviourLanguage.g:2448:4: kw= '-'
                    {
            ...
            // InternalBehaviourLanguage.g:2454:3: (this_INT_1= RULE_INT )?
            int alt44=2;
            ...
            switch (alt44) {
                case 1 :
                    // InternalBehaviourLanguage.g:2455:4: this_INT_1= RULE_INT
                    {
            ...
            kw=(Token)match(input,55,FOLLOW_63); 
            ...
            // InternalBehaviourLanguage.g:2475:3: ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )?
            int alt47=2;
            int LA47_0 = input.LA(1);

            if ( ((LA47_0>=56 && LA47_0<=57)) ) {
                alt47=1;
            }
            switch (alt47) {
                case 1 :
                    // InternalBehaviourLanguage.g:2476:4: (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT
                    {
                    // InternalBehaviourLanguage.g:2476:4: (kw= 'E' | kw= 'e' )
                    int alt45=2;
                    ...
                    switch (alt45) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2477:5: kw= 'E'
                            {
                            kw=(Token)match(input,56,FOLLOW_39); 
                            ...
                            break;
                        case 2 :
                            // InternalBehaviourLanguage.g:2483:5: kw= 'e'
                            {
                            kw=(Token)match(input,57,FOLLOW_39); 
                    ...
                    // InternalBehaviourLanguage.g:2489:4: (kw= '-' )?
                    int alt46=2;
                    ...
                    switch (alt46) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2490:5: kw= '-'
                            {
                            kw=(Token)match(input,54,FOLLOW_63); 
    ...
    // InternalBehaviourLanguage.g:2508:1: entryRulePropertyKey returns [EObject current=null] : iv_rulePropertyKey= rulePropertyKey EOF ;
    public final EObject entryRulePropertyKey() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2508:52: (iv_rulePropertyKey= rulePropertyKey EOF )
            // InternalBehaviourLanguage.g:2509:2: iv_rulePropertyKey= rulePropertyKey EOF
            {
    ...
    // InternalBehaviourLanguage.g:2515:1: rulePropertyKey returns [EObject current=null] : ( () otherlv_1= 'PropertyKey' ( (lv_name_2_0= ruleEString ) ) ) ;
    public final EObject rulePropertyKey() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2521:2: ( ( () otherlv_1= 'PropertyKey' ( (lv_name_2_0= ruleEString ) ) ) )
            // InternalBehaviourLanguage.g:2522:2: ( () otherlv_1= 'PropertyKey' ( (lv_name_2_0= ruleEString ) ) )
            {
            // InternalBehaviourLanguage.g:2522:2: ( () otherlv_1= 'PropertyKey' ( (lv_name_2_0= ruleEString ) ) )
            // InternalBehaviourLanguage.g:2523:3: () otherlv_1= 'PropertyKey' ( (lv_name_2_0= ruleEString ) )
            {
            // InternalBehaviourLanguage.g:2523:3: ()
            // InternalBehaviourLanguage.g:2524:4: 
            {
            ...
            // InternalBehaviourLanguage.g:2534:3: ( (lv_name_2_0= ruleEString ) )
            // InternalBehaviourLanguage.g:2535:4: (lv_name_2_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:2535:4: (lv_name_2_0= ruleEString )
            // InternalBehaviourLanguage.g:2536:5: lv_name_2_0= ruleEString
            {
    ...
    // InternalBehaviourLanguage.g:2557:1: entryRuleStringValue returns [EObject current=null] : iv_ruleStringValue= ruleStringValue EOF ;
    public final EObject entryRuleStringValue() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2557:52: (iv_ruleStringValue= ruleStringValue EOF )
            // InternalBehaviourLanguage.g:2558:2: iv_ruleStringValue= ruleStringValue EOF
            {
    ...
    // InternalBehaviourLanguage.g:2564:1: ruleStringValue returns [EObject current=null] : (otherlv_0= 'StringValue' otherlv_1= '{' otherlv_2= 'value' ( (lv_value_3_0= ruleEString ) ) otherlv_4= '}' ) ;
    public final EObject ruleStringValue() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2570:2: ( (otherlv_0= 'StringValue' otherlv_1= '{' otherlv_2= 'value' ( (lv_value_3_0= ruleEString ) ) otherlv_4= '}' ) )
            // InternalBehaviourLanguage.g:2571:2: (otherlv_0= 'StringValue' otherlv_1= '{' otherlv_2= 'value' ( (lv_value_3_0= ruleEString ) ) otherlv_4= '}' )
            {
            // InternalBehaviourLanguage.g:2571:2: (otherlv_0= 'StringValue' otherlv_1= '{' otherlv_2= 'value' ( (lv_value_3_0= ruleEString ) ) otherlv_4= '}' )
            // InternalBehaviourLanguage.g:2572:3: otherlv_0= 'StringValue' otherlv_1= '{' otherlv_2= 'value' ( (lv_value_3_0= ruleEString ) ) otherlv_4= '}'
            {
            ...
            // InternalBehaviourLanguage.g:2584:3: ( (lv_value_3_0= ruleEString ) )
            // InternalBehaviourLanguage.g:2585:4: (lv_value_3_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:2585:4: (lv_value_3_0= ruleEString )
            // InternalBehaviourLanguage.g:2586:5: lv_value_3_0= ruleEString
            {
    ...
    // InternalBehaviourLanguage.g:2611:1: entryRuleMessage returns [EObject current=null] : iv_ruleMessage= ruleMessage EOF ;
    public final EObject entryRuleMessage() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2611:48: (iv_ruleMessage= ruleMessage EOF )
            // InternalBehaviourLanguage.g:2612:2: iv_ruleMessage= ruleMessage EOF
            {
    ...
    public final EObject ruleMessage() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2624:2: ( ( ( (lv_name_0_0= ruleEString ) ) (otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}' )? ) )
            // InternalBehaviourLanguage.g:2625:2: ( ( (lv_name_0_0= ruleEString ) ) (otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}' )? )
            {
            // InternalBehaviourLanguage.g:2625:2: ( ( (lv_name_0_0= ruleEString ) ) (otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}' )? )
            // InternalBehaviourLanguage.g:2626:3: ( (lv_name_0_0= ruleEString ) ) (otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}' )?
            {
            // InternalBehaviourLanguage.g:2626:3: ( (lv_name_0_0= ruleEString ) )
            // InternalBehaviourLanguage.g:2627:4: (lv_name_0_0= ruleEString )
            {
            // InternalBehaviourLanguage.g:2627:4: (lv_name_0_0= ruleEString )
            // InternalBehaviourLanguage.g:2628:5: lv_name_0_0= ruleEString
            {
            ...
            // InternalBehaviourLanguage.g:2645:3: (otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}' )?
            int alt56=2;
            ...
            switch (alt56) {
                case 1 :
                    // InternalBehaviourLanguage.g:2646:4: otherlv_1= '{' (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )? (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )? (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )? (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )? (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )? otherlv_24= '}'
                    {
                    ...
                    // InternalBehaviourLanguage.g:2650:4: (otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')' )?
                    int alt49=2;
                    ...
                    switch (alt49) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2651:5: otherlv_2= 'TaskExecutions' otherlv_3= '(' ( (otherlv_4= RULE_ID ) ) (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )* otherlv_7= ')'
                            {
                            otherlv_2=(Token)match(input,17,FOLLOW_43); 
                            ...
                            // InternalBehaviourLanguage.g:2659:5: ( (otherlv_4= RULE_ID ) )
                            // InternalBehaviourLanguage.g:2660:6: (otherlv_4= RULE_ID )
                            {
                            // InternalBehaviourLanguage.g:2660:6: (otherlv_4= RULE_ID )
                            // InternalBehaviourLanguage.g:2661:7: otherlv_4= RULE_ID
                            {
                            ...
                            // InternalBehaviourLanguage.g:2672:5: (otherlv_5= ',' ( (otherlv_6= RULE_ID ) ) )*
                            loop48:
                            do {
                                int alt48=2;
                                ...
                                switch (alt48) {
                            	case 1 :
                            	    // InternalBehaviourLanguage.g:2673:6: otherlv_5= ',' ( (otherlv_6= RULE_ID ) )
                            	    {
                            	    otherlv_5=(Token)match(input,15,FOLLOW_17); 

                            	    						newLeafNode(otherlv_5, grammarAccess.getMessageAccess().getCommaKeyword_1_1_3_0());
                            	    					
                            	    // InternalBehaviourLanguage.g:2677:6: ( (otherlv_6= RULE_ID ) )
                            	    // InternalBehaviourLanguage.g:2678:7: (otherlv_6= RULE_ID )
                            	    {
                            	    // InternalBehaviourLanguage.g:2678:7: (otherlv_6= RULE_ID )
                            	    // InternalBehaviourLanguage.g:2679:8: otherlv_6= RULE_ID
                            	    {
                            ...
                            otherlv_7=(Token)match(input,32,FOLLOW_67); 
                    ...
                    // InternalBehaviourLanguage.g:2696:4: (otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')' )?
                    int alt51=2;
                    ...
                    switch (alt51) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2697:5: otherlv_8= 'Objects' otherlv_9= '(' ( (otherlv_10= RULE_ID ) ) (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )* otherlv_13= ')'
                            {
                            otherlv_8=(Token)match(input,60,FOLLOW_43); 
                            ...
                            // InternalBehaviourLanguage.g:2705:5: ( (otherlv_10= RULE_ID ) )
                            // InternalBehaviourLanguage.g:2706:6: (otherlv_10= RULE_ID )
                            {
                            // InternalBehaviourLanguage.g:2706:6: (otherlv_10= RULE_ID )
                            // InternalBehaviourLanguage.g:2707:7: otherlv_10= RULE_ID
                            {
                            ...
                            // InternalBehaviourLanguage.g:2718:5: (otherlv_11= ',' ( (otherlv_12= RULE_ID ) ) )*
                            loop50:
                            do {
                                int alt50=2;
                                ...
                                switch (alt50) {
                            	case 1 :
                            	    // InternalBehaviourLanguage.g:2719:6: otherlv_11= ',' ( (otherlv_12= RULE_ID ) )
                            	    {
                            	    otherlv_11=(Token)match(input,15,FOLLOW_17); 

                            	    						newLeafNode(otherlv_11, grammarAccess.getMessageAccess().getCommaKeyword_1_2_3_0());
                            	    					
                            	    // InternalBehaviourLanguage.g:2723:6: ( (otherlv_12= RULE_ID ) )
                            	    // InternalBehaviourLanguage.g:2724:7: (otherlv_12= RULE_ID )
                            	    {
                            	    // InternalBehaviourLanguage.g:2724:7: (otherlv_12= RULE_ID )
                            	    // InternalBehaviourLanguage.g:2725:8: otherlv_12= RULE_ID
                            	    {
                            ...
                            otherlv_13=(Token)match(input,32,FOLLOW_68); 
                    ...
                    // InternalBehaviourLanguage.g:2742:4: (otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) ) )?
                    int alt52=2;
                    ...
                    switch (alt52) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2743:5: otherlv_14= 'Follows' ( (otherlv_15= RULE_ID ) )
                            {
                            otherlv_14=(Token)match(input,61,FOLLOW_17); 

                            					newLeafNode(otherlv_14, grammarAccess.getMessageAccess().getFollowsKeyword_1_3_0());
                            				
                            // InternalBehaviourLanguage.g:2747:5: ( (otherlv_15= RULE_ID ) )
                            // InternalBehaviourLanguage.g:2748:6: (otherlv_15= RULE_ID )
                            {
                            // InternalBehaviourLanguage.g:2748:6: (otherlv_15= RULE_ID )
                            // InternalBehaviourLanguage.g:2749:7: otherlv_15= RULE_ID
                            {
                            ...
                            otherlv_15=(Token)match(input,RULE_ID,FOLLOW_69); 
                    ...
                    // InternalBehaviourLanguage.g:2761:4: (otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}' )?
                    int alt54=2;
                    ...
                    switch (alt54) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2762:5: otherlv_16= 'Properties' otherlv_17= '{' ( (lv_properties_18_0= ruleProperty ) ) (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )* otherlv_21= '}'
                            {
                            otherlv_16=(Token)match(input,62,FOLLOW_6); 

                            					newLeafNode(otherlv_16, grammarAccess.getMessageAccess().getPropertiesKeyword_1_4_0());
                            				
                            otherlv_17=(Token)match(input,13,FOLLOW_45); 

                            					newLeafNode(otherlv_17, grammarAccess.getMessageAccess().getLeftCurlyBracketKeyword_1_4_1());
                            				
                            // InternalBehaviourLanguage.g:2770:5: ( (lv_properties_18_0= ruleProperty ) )
                            // InternalBehaviourLanguage.g:2771:6: (lv_properties_18_0= ruleProperty )
                            {
                            // InternalBehaviourLanguage.g:2771:6: (lv_properties_18_0= ruleProperty )
                            // InternalBehaviourLanguage.g:2772:7: lv_properties_18_0= ruleProperty
                            {
                            ...
                            // InternalBehaviourLanguage.g:2789:5: (otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) ) )*
                            loop53:
                            do {
                                int alt53=2;
                                ...
                                switch (alt53) {
                            	case 1 :
                            	    // InternalBehaviourLanguage.g:2790:6: otherlv_19= ',' ( (lv_properties_20_0= ruleProperty ) )
                            	    {
                            	    otherlv_19=(Token)match(input,15,FOLLOW_45); 

                            	    						newLeafNode(otherlv_19, grammarAccess.getMessageAccess().getCommaKeyword_1_4_3_0());
                            	    					
                            	    // InternalBehaviourLanguage.g:2794:6: ( (lv_properties_20_0= ruleProperty ) )
                            	    // InternalBehaviourLanguage.g:2795:7: (lv_properties_20_0= ruleProperty )
                            	    {
                            	    // InternalBehaviourLanguage.g:2795:7: (lv_properties_20_0= ruleProperty )
                            	    // InternalBehaviourLanguage.g:2796:8: lv_properties_20_0= ruleProperty
                            	    {
                    ...
                    // InternalBehaviourLanguage.g:2819:4: (otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) ) )?
                    int alt55=2;
                    ...
                    switch (alt55) {
                        case 1 :
                            // InternalBehaviourLanguage.g:2820:5: otherlv_22= 'TTL' ( (lv_TTL_23_0= ruleMeasureValue ) )
                            {
                            otherlv_22=(Token)match(input,63,FOLLOW_37); 

                            					newLeafNode(otherlv_22, grammarAccess.getMessageAccess().getTTLKeyword_1_5_0());
                            				
                            // InternalBehaviourLanguage.g:2824:5: ( (lv_TTL_23_0= ruleMeasureValue ) )
                            // InternalBehaviourLanguage.g:2825:6: (lv_TTL_23_0= ruleMeasureValue )
                            {
                            // InternalBehaviourLanguage.g:2825:6: (lv_TTL_23_0= ruleMeasureValue )
                            // InternalBehaviourLanguage.g:2826:7: lv_TTL_23_0= ruleMeasureValue
                            {
    ...
    // InternalBehaviourLanguage.g:2853:1: entryRuleEInt returns [String current=null] : iv_ruleEInt= ruleEInt EOF ;
    public final String entryRuleEInt() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2853:44: (iv_ruleEInt= ruleEInt EOF )
            // InternalBehaviourLanguage.g:2854:2: iv_ruleEInt= ruleEInt EOF
            {
    ...
    // InternalBehaviourLanguage.g:2860:1: ruleEInt returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? this_INT_1= RULE_INT ) ;
    public final AntlrDatatypeRuleToken ruleEInt() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2866:2: ( ( (kw= '-' )? this_INT_1= RULE_INT ) )
            // InternalBehaviourLanguage.g:2867:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            {
            // InternalBehaviourLanguage.g:2867:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            // InternalBehaviourLanguage.g:2868:3: (kw= '-' )? this_INT_1= RULE_INT
            {
            // InternalBehaviourLanguage.g:2868:3: (kw= '-' )?
            int alt57=2;
            ...
            switch (alt57) {
                case 1 :
                    // InternalBehaviourLanguage.g:2869:4: kw= '-'
                    {
                    kw=(Token)match(input,54,FOLLOW_63); 
    ...
    // InternalBehaviourLanguage.g:2886:1: ruleRobotStatus returns [Enumerator current=null] : ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'TurnedOff' ) | (enumLiteral_2= 'Waiting' ) | (enumLiteral_3= 'Executing' ) ) ;
    public final Enumerator ruleRobotStatus() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2892:2: ( ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'TurnedOff' ) | (enumLiteral_2= 'Waiting' ) | (enumLiteral_3= 'Executing' ) ) )
            // InternalBehaviourLanguage.g:2893:2: ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'TurnedOff' ) | (enumLiteral_2= 'Waiting' ) | (enumLiteral_3= 'Executing' ) )
            {
            // InternalBehaviourLanguage.g:2893:2: ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'TurnedOff' ) | (enumLiteral_2= 'Waiting' ) | (enumLiteral_3= 'Executing' ) )
            int alt58=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt58) {
                case 1 :
                    // InternalBehaviourLanguage.g:2894:3: (enumLiteral_0= 'Ready' )
                    {
                    // InternalBehaviourLanguage.g:2894:3: (enumLiteral_0= 'Ready' )
                    // InternalBehaviourLanguage.g:2895:4: enumLiteral_0= 'Ready'
                    {
                    ...
                    break;
                case 2 :
                    // InternalBehaviourLanguage.g:2902:3: (enumLiteral_1= 'TurnedOff' )
                    {
                    // InternalBehaviourLanguage.g:2902:3: (enumLiteral_1= 'TurnedOff' )
                    // InternalBehaviourLanguage.g:2903:4: enumLiteral_1= 'TurnedOff'
                    {
                    ...
                    break;
                case 3 :
                    // InternalBehaviourLanguage.g:2910:3: (enumLiteral_2= 'Waiting' )
                    {
                    // InternalBehaviourLanguage.g:2910:3: (enumLiteral_2= 'Waiting' )
                    // InternalBehaviourLanguage.g:2911:4: enumLiteral_2= 'Waiting'
                    {
                    ...
                    break;
                case 4 :
                    // InternalBehaviourLanguage.g:2918:3: (enumLiteral_3= 'Executing' )
                    {
                    // InternalBehaviourLanguage.g:2918:3: (enumLiteral_3= 'Executing' )
                    // InternalBehaviourLanguage.g:2919:4: enumLiteral_3= 'Executing'
                    {
    ...
    // InternalBehaviourLanguage.g:2929:1: ruleTaskExecutionStatus returns [Enumerator current=null] : ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'Finished' ) | (enumLiteral_2= 'Suspended' ) | (enumLiteral_3= 'InProgress' ) | (enumLiteral_4= 'Waiting' ) ) ;
    public final Enumerator ruleTaskExecutionStatus() throws RecognitionException {
        ...
        try {
            // InternalBehaviourLanguage.g:2935:2: ( ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'Finished' ) | (enumLiteral_2= 'Suspended' ) | (enumLiteral_3= 'InProgress' ) | (enumLiteral_4= 'Waiting' ) ) )
            // InternalBehaviourLanguage.g:2936:2: ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'Finished' ) | (enumLiteral_2= 'Suspended' ) | (enumLiteral_3= 'InProgress' ) | (enumLiteral_4= 'Waiting' ) )
            {
            // InternalBehaviourLanguage.g:2936:2: ( (enumLiteral_0= 'Ready' ) | (enumLiteral_1= 'Finished' ) | (enumLiteral_2= 'Suspended' ) | (enumLiteral_3= 'InProgress' ) | (enumLiteral_4= 'Waiting' ) )
            int alt59=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt59) {
                case 1 :
                    // InternalBehaviourLanguage.g:2937:3: (enumLiteral_0= 'Ready' )
                    {
                    // InternalBehaviourLanguage.g:2937:3: (enumLiteral_0= 'Ready' )
                    // InternalBehaviourLanguage.g:2938:4: enumLiteral_0= 'Ready'
                    {
                    enumLiteral_0=(Token)match(input,64,FOLLOW_2); 
                    ...
                    break;
                case 2 :
                    // InternalBehaviourLanguage.g:2945:3: (enumLiteral_1= 'Finished' )
                    {
                    // InternalBehaviourLanguage.g:2945:3: (enumLiteral_1= 'Finished' )
                    // InternalBehaviourLanguage.g:2946:4: enumLiteral_1= 'Finished'
                    {
                    ...
                    break;
                case 3 :
                    // InternalBehaviourLanguage.g:2953:3: (enumLiteral_2= 'Suspended' )
                    {
                    // InternalBehaviourLanguage.g:2953:3: (enumLiteral_2= 'Suspended' )
                    // InternalBehaviourLanguage.g:2954:4: enumLiteral_2= 'Suspended'
                    {
                    ...
                    break;
                case 4 :
                    // InternalBehaviourLanguage.g:2961:3: (enumLiteral_3= 'InProgress' )
                    {
                    // InternalBehaviourLanguage.g:2961:3: (enumLiteral_3= 'InProgress' )
                    // InternalBehaviourLanguage.g:2962:4: enumLiteral_3= 'InProgress'
                    {
                    ...
                    break;
                case 5 :
                    // InternalBehaviourLanguage.g:2969:3: (enumLiteral_4= 'Waiting' )
                    {
                    // InternalBehaviourLanguage.g:2969:3: (enumLiteral_4= 'Waiting' )
                    // InternalBehaviourLanguage.g:2970:4: enumLiteral_4= 'Waiting'
                    {
    ...
    public static final BitSet FOLLOW_33 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000075L});
    public static final BitSet FOLLOW_34 = new BitSet(new long[]{0x0000000000000000L,0x000000000000000FL});
    ...
    public static final BitSet FOLLOW_39 = new BitSet(new long[]{0x0040000000000040L});
    public static final BitSet FOLLOW_40 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_41 = new BitSet(new long[]{0x00001E0000010000L});
    public static final BitSet FOLLOW_42 = new BitSet(new long[]{0x00001C0000010000L});
    public static final BitSet FOLLOW_43 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_44 = new BitSet(new long[]{0x0000180000010000L});
    public static final BitSet FOLLOW_45 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_46 = new BitSet(new long[]{0x0000100000010000L});
    public static final BitSet FOLLOW_47 = new BitSet(new long[]{0x0010000000000000L});
    public static final BitSet FOLLOW_48 = new BitSet(new long[]{0x0000400000010000L});
    ...
    public static final BitSet FOLLOW_51 = new BitSet(new long[]{0x0000080080000002L});
    ...
    public static final BitSet FOLLOW_56 = new BitSet(new long[]{0x000A000000000000L});
    public static final BitSet FOLLOW_57 = new BitSet(new long[]{0x00C0000000000040L});
    ...
    public static final BitSet FOLLOW_60 = new BitSet(new long[]{0x0000080000010000L});
    public static final BitSet FOLLOW_61 = new BitSet(new long[]{0x0080000000000040L});
    ...
    public static final BitSet FOLLOW_64 = new BitSet(new long[]{0x0300000000000002L});
    public static final BitSet FOLLOW_65 = new BitSet(new long[]{0x0000000000002002L});
    public static final BitSet FOLLOW_66 = new BitSet(new long[]{0xF000000000030000L});
    public static final BitSet FOLLOW_67 = new BitSet(new long[]{0xF000000000010000L});
    public static final BitSet FOLLOW_68 = new BitSet(new long[]{0xE000000000010000L});
    public static final BitSet FOLLOW_69 = new BitSet(new long[]{0xC000000000010000L});
    public static final BitSet FOLLOW_70 = new BitSet(new long[]{0x8000000000010000L});
