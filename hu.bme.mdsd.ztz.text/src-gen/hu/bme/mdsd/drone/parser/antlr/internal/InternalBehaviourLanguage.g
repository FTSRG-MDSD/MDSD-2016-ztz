...
entryRuleTaskDescriptor returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTaskDescriptorRule()); }
	iv_ruleTaskDescriptor=ruleTaskDescriptor
	{ $current=$iv_ruleTaskDescriptor.current; }
	EOF;

// Rule TaskDescriptor
ruleTaskDescriptor returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMeasureConversion returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMeasureConversionRule()); }
	iv_ruleMeasureConversion=ruleMeasureConversion
	{ $current=$iv_ruleMeasureConversion.current; }
	EOF;

// Rule MeasureConversion
ruleMeasureConversion returns [EObject current=null]
@init {
	enterRule();
}
@after {
