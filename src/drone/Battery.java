 ...
 * </p>
 * <ul>
 *   <li>{@link drone.Battery#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link drone.Battery#getVoltage <em>Voltage</em>}</li>
 *   <li>{@link drone.Battery#getRechargeTime <em>Recharge Time</em>}</li>
 *   <li>{@link drone.Battery#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @see drone.DronePackage#getBattery()
 * @model
 * @generated
 */
public interface Battery extends EObject {
         ...
         * @see drone.DronePackage#getBattery_Capacity()
        ...
        /**
         * Sets the value of the '{@link drone.Battery#getCapacity <em>Capacity</em>}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @see drone.DronePackage#getBattery_Voltage()
         * @model containment="true" required="true"
         * @generated
         */
        ...
        /**
         * Sets the value of the '{@link drone.Battery#getVoltage <em>Voltage</em>}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @see drone.DronePackage#getBattery_RechargeTime()
         * @model containment="true" required="true"
         * @generated
         */
        ...
        /**
         * Sets the value of the '{@link drone.Battery#getRechargeTime <em>Recharge Time</em>}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @see drone.DronePackage#getBattery_Properties()
